...
class __Mustache_e02af4b15b7f4a4d262a20d549210b73 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionBbb6de993b331c93778a4240f211416f($context, $indent, $value);
        $buffer .= $indent . '            </div>
';
...
';
    ...
    private function sectionBbb6de993b331c93778a4240f211416f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
                    <a class="edit-icon" href="{{edit_course}}" target="_blank"
                       title="Edit Course">
            ...
            foreach ($values as $value) {
                ...
                $value = $this->resolveValue($context->find('edit_course'), $context);
                $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
