...
class __Mustache_3bc0596b0276a1b4f5dd6bd004c3414f extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section3f633f0f57384f71df8149f5b20e5ab8($context, $indent, $value);
...
';
    ...
    private function section3f633f0f57384f71df8149f5b20e5ab8(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    require([\'theme_boost/loader\', \'theme_boost/drawer\', \'jquery\'], function(Loader, Drawer, $) {
        ...
        $(".drawer .drawercontent.drag-container").append(`<ul class="list-group list-group-custom-menus">${custommenus}</ul>`);
...
';
                $buffer .= $indent . '        $(".drawer .drawercontent.drag-container").append(`<ul class="list-group list-group-custom-menus">${custommenus}</ul>`);
';
