...
class __Mustache_2cedd68f4f270a6929c011b7d7ecfd1d extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section70f479ddaa739c3ef531253781d6040a($context, $indent, $value);
        $buffer .= $indent . '
';
        $value = $context->find('maintenancefooter');
        if (empty($value)) {
...
';
            ...
            if (empty($value)) {
                ...
                $buffer .= $this->sectionE08df9bacb5cd8de6890c7d9c8516d05($context, $indent, $value);
            }
            $buffer .= $indent . '
';
...
';
    ...
    private function section70f479ddaa739c3ef531253781d6040a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '                <p>Designed by NET2GO</p>
';
                $buffer .= $indent . '            </div>
';
                $buffer .= $indent . '        </div>
...
';
    ...
    private function sectionCe8f590633a830a386730e61de750b41(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '                                        Designed by NET2GO
';
                $buffer .= $indent . '                                    </p>
';
                $buffer .= $indent . '                                </div>
...
';
    ...
    private function sectionE08df9bacb5cd8de6890c7d9c8516d05(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionCe8f590633a830a386730e61de750b41($context, $indent, $value);
                $buffer .= $indent . '                    </div>
';
                $buffer .= $indent . '                </div>
';
