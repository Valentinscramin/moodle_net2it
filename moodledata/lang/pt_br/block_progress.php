...
/**
 * Strings for component 'block_progress', language 'pt_br', version '4.5'.
 *
...
$string['aspirelist'] = 'Lista de recursos Aspire';
...
$string['config_header_showsubmitted'] = 'Mostrar enviado antes da ação';
$string['config_icons'] = 'Usar ícones na barra';
$string['config_longbars'] = 'Como apresentar barras longas';
...
$string['config_scroll'] = 'Rolar';
$string['config_squeeze'] = 'Apertar';
$string['config_title'] = 'Título alternativo';
$string['config_warning_loglifetime'] = 'Aviso: Os logs são limpos após {$a} dia(s). Ações que dependem de visualizações serão afetadas por isso.';
$string['config_warning_logstores'] = 'Aviso: O log está desabilitado, portanto, ações que dependem de visualizações não serão verificadas.';
$string['config_wrap'] = 'Enrolar';
$string['coursenametoshow'] = 'Nome do curso exibido no Painel';
$string['cross'] = 'Cruz';
$string['data'] = 'Database';
$string['defaultlongbars'] = 'Apresentação padrão para barras longas';
$string['dmelearn'] = 'Mídia Digital e-Learning';
...
$string['folder'] = 'Pasta';
$string['forum'] = 'Fórum';
$string['fullname'] = 'Nome completo do curso';
...
$string['how_longbars_works'] = 'Como as barras longas são exibidas';
$string['how_longbars_works_help'] = '<p>Quando as barras excedem um comprimento definido, elas podem ser apresentadas das seguintes maneiras.</p>
<ul>
    <li>Apertadas em uma barra horizontal</li>
    <li>Rolando para o lado para mostrar segmentos de barra excedentes</li>
    <li>Enrolando para mostrar todos os segmentos de barra em várias linhas</li>
</ul>
<p>Observe que quando a barra é enrolada, o indicador AGORA não será exibido.</p>';
...
$string['mouse_over_prompt'] = 'Passe o mouse ou toque na barra para informações.';
$string['no_blocks'] = 'Nenhum bloco Barra de Progresso estão configurados para os seus cursos.';
$string['no_courses'] = 'Você não está matriculado em nenhum curso. Apenas barras de cursos matriculados serão mostradas.';
...
$string['passedby'] = 'aprovado pelo prazo';
...
$string['progress:showbar'] = 'Mostrar a barra no bloco da Barra de Progresso';
...
$string['shortname'] = 'Nome curto do curso';
$string['showallinfo'] = 'Mostrar todas as informações';
$string['showinactive'] = 'Mostrar estudantes inativos na Visão Geral';
...
$string['submittednotcomplete_colour_title'] = 'Cor de enviado, mas não concluído';
...
$string['vpl'] = 'Laboratório de Programação Virtual';
$string['what_actions_can_be_monitored'] = 'Quais as ações podem ser monitoradas?';
$string['what_actions_can_be_monitored_help'] = '<p>Uma série de diferentes ações podem ser possíveis para uma atividade.</p>
<p>Por exemplo, com o módulo de Atividade, as ações possíveis são:
    <ul>
        <li>enviado,</li>
        <li>avaliado,</li>
        <li>aprovado (veja anotação sobre aprovação abaixo),</li>
        <li>aprovado pelo prazo (veja anotação sobre aprovação abaixo) e</li>
        <li>conclusão da atividade (quando habilitado no site, curso e definido para a atividade).</li>
    </ul>
</p>
<h3>Aprovação</h3>
<p>Para os módulos de tarefa, lição e questionário, o conceito de aprovação depende de um "Nota para aprovação" definido para o item de note no Livro de Notas. <a href="http://docs.moodle.org/en/Grade_items#Activity-based_grade_items" target="_blank">Mais ajuda...</a></p>';
