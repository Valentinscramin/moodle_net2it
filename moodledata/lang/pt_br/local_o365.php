...
/**
 * Strings for component 'local_o365', language 'pt_br', version '4.5'.
 *
 * @package     local_o365
 * @category    string
...
$string['acp_coursesynccustom_oncustom'] = 'Personalizar<br />Permite que usuários autorizados escolham quais cursos criar equipes.<br> <span id="adminsetting_coursesync" style="font-weight: bold"><a href="{$a}">Personalizar sincronização de cursos</a></span>';
...
$string['settings_debugmode_details'] = 'Se ativado, informações serão registradas no log do Moodle que podem ajudar a identificar problemas. <a href="{$a}">Ver mensagens de log registradas.</a>';
