...
/**
 * Strings for component 'adaptivequiz', language 'pt_br', version '4.5'.
 *
...
$string['calcerrorwithinlimits'] = 'O erro padrão calculado de {$a->calerror} está dentro dos limites impostos pela atividade {$a->definederror}';
...
$string['confirmdeleteattempt'] = 'Confirmando a exclusão da tentativa de {$a->name} enviada em {$a->timecompleted}';
...
$string['reportanswersdistributionchartnumrightlabel'] = 'Número de respostas corretas';
$string['reportanswersdistributionchartnumwronglabel'] = 'Número de respostas erradas';
$string['reportanswersdistributionchartxaxislabel'] = 'Dificuldade da questão';
$string['reportanswersdistributionchartyaxislabel'] = 'Número de respostas';
...
$string['reviewattemptreport'] = 'Revisando a tentativa de {$a->fullname} enviada em {$a->finished}';
