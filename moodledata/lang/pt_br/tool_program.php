...
/**
 * Strings for component 'tool_program', language 'pt_br', version '4.5'.
 *
...
$string['name'] = 'Nome';
$string['never'] = 'Nunca';
$string['newemptycourse'] = 'Novo curso vazio';
...
$string['outcomeallocationdesckeepdate'] = 'Cancele a suspensão e deixe as datas de início/término do programa existentes';
$string['outcomeallocationdesckeepstartdate'] = 'Manter a data de início padrão do programa';
$string['outcomeallocationdescstartdate'] = 'Data de início do programa: \'{$a->startdate}\'';
$string['outcomeallocationdescsuspendchangedate'] = 'Cancele a suspensão e altere as datas de início/término do programa';
$string['outcomeallocationdontmodify'] = 'Não modifique as alocações';
$string['outcomeallocationsuspendedusers'] = 'Com usuários suspensos';
$string['outcomeallocationsuspendedusers_help'] = 'Ação a ser executada quando os usuários já estão alocados, mas sua alocação está suspensa ou encerrada';
$string['outcomeallocationunsuspend'] = 'Cancelar a suspensão, deixar as datas de início/término do programa existentes';
$string['outcomeallocationunsuspendchangedate'] = 'Cancelar a suspensão, alterar as datas de início/término do programa';
$string['outcomedeallocate'] = 'Desalocar usuário do programa';
$string['outcomedeallocatesuspend'] = 'Suspender a alocação existente';
...
$string['outcomedeallocationdescriptionsuspend'] = 'Suspender alocações de usuários existentes do programa \'{$a}\'';
$string['overdue'] = 'Atrasado';
$string['overdueprograms'] = 'Programas atrasados';
...
$string['programdates'] = 'Datas';
$string['programdates_help'] = 'Selecione as datas aplicáveis a esta alocação do programa:

* **Igual ao definido nos programas:** Serão utilizadas as datas definidas nos programas.
* **Selecionar data:** Você pode selecionar uma data específica (início, vencimento, término) para esta alocação de programa.';
...
$string['usersdeallocatedsuccess'] = '{$a} usuário(s) foram desalocados com sucesso';
$string['userseditedsuccess'] = '{$a} usuário(s) foram modificados com sucesso';
