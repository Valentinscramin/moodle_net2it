...
/**
 * Strings for component 'qtype_calculated', language 'pt_br', version '4.5'.
 *
...
$string['atleastonerealdataset'] = 'Deve haver pelo menos um conjunto de dados reais no texto da questão';
$string['atleastonewildcard'] = 'Deve haver pelo menos um curinga na fórmula de resposta ou texto da questão';
...
$string['newlocal3'] = 'um link de um novo conjunto de links que só serão usados por esta questão';
...
$string['youmustaddatleastoneitem'] = 'Vocè precisa adicionar, ao menos, um conjunto de dados antes de salvar esta questão.';
$string['youmustaddatleastonevalue'] = 'Você precisa adicionar, ao menos, um conjunto de curinga antes de salvar esta questão.';
