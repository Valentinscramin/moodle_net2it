...
/**
 * Strings for component 'tool_wp', language 'pt_br', version '4.5'.
 *
 * @package     tool_wp
 * @category    string
...
$string['exportercreatefromcurrenttenant'] = 'Tenant atual';
...
$string['exportimportuserslanguseselected'] = 'Utilizar o idioma selecionado';
$string['exportimportusersmanual'] = 'Selecionar usuários manualmente...';
$string['exportimportusersmnetconflict'] = 'O valor do host MNet é diferente';
$string['exportimportusersmnetmatchlocal'] = 'Atualizar valor para corresponder ao site';
$string['exportimportusersmnetuseexisting'] = 'Importar com valor existente';
$string['exportimportuserspicture'] = 'Imagens de usuário';
$string['exportimportusersprofile'] = 'Perfis de usuário';
$string['exportimportuserssuccess'] = 'Usuário \'{$a}\' criado';
...
$string['exportnotfoundornotready'] = 'Exportação não encontrada ou não pronta para importação';
$string['exportnotready'] = 'A exportação não está pronta para importação';
...
$string['exportselectallreports'] = 'Exportar todos os relatórios personalizados';
$string['exportselectlimitreports'] = 'Exportar relatórios personalizados específicos...';
...
$string['importaudiencelogerror'] = 'Não foi possível importar o registro de público';
$string['importaudiencelogsuccess'] = 'Registro de público importado';
...
$string['importeitherexportidorfile'] = 'Exportid ou o arquivo precisam ser especificados, mas não ambos.';
$string['importer'] = 'Importador';
$string['importernotfound'] = 'O importador {$a} não foi encontrado ou não está disponível';
$string['importerrequired'] = 'Mais de um importador está disponível, o importador deve ser especificado';
$string['importersettingsinvalid'] = 'As configurações do importador não estão no formato JSON válido';
$string['importersettingsvalidationfailed'] = 'Falha na validação das configurações do importador: {$a}';
...
$string['importhasconflits'] = 'A importação tem conflitos: {$a}';
...
$string['importlogerrorinvalidaudience'] = 'Público-alvo ausente ou inválido';
$string['importlogerrorinvalidreportsource'] = 'Fonte de relatório ausente ou inválida';
$string['importlogerrorinvalidreporttype'] = 'Tipo de relatório inválido';
$string['importlogerrorinvalidscheduleformat'] = 'Formato de agendamento ausente ou inválido';
...
$string['importreportlogerror'] = 'Não foi possível importar o relatório \'{$a}\'';
...
$string['importschedulelogerror'] = 'Não foi possível importar o registro da programação';
$string['importschedulelogsuccess'] = 'Registro de agendamento importado';
$string['importselectallreports'] = 'Importar todos os relatórios personalizados';
$string['importselectlimitreports'] = 'Importar um relatório personalizado específico';
...
$string['includecoursecontent'] = 'Incluir conteúdo do curso';
...
$string['mappingerrorcertificateheader'] = 'Alguns modelos de certificado não existem';
$string['mappingerrorcertificatelog'] = 'O certificado {$a} não foi encontrado';
...
$string['mappingerrorlpheader'] = 'Alguns modelos de planos de aprendizagem não existem';
$string['mappingerrorlplog'] = 'O modelo de plano de aprendizagem {$a} não foi encontrado';
...
$string['migrationcannotswitchtenant'] = 'O locatário com id ou idnumber {$a} não foi encontrado ou você não tem permissão para mudar para ele';
$string['migrationreportaudiences'] = 'Audiências';
$string['migrationreportdefinition'] = 'Definição do relatório';
$string['migrationreportdefinition_help'] = 'Incluir colunas, condições e filtros do relatório';
$string['migrationreportschedules'] = 'Schedules';
$string['migrationschoosefrom'] = 'Escolha entre';
$string['noavailableimporter'] = 'Não encontramos um importador disponível para este arquivo.';
$string['noavailableimporters'] = 'Nenhum importador disponível';
...
$string['reg_wpactiveusersyear'] = 'Número de usuários únicos que fizeram login nos últimos 12 meses ({$a})';
...
$string['reg_wpproductionstate'] = 'Estado de produção ({$a})';
$string['reg_wprelease'] = 'Número de versão do Moodle Workplace ({$a})';
