...
/**
 * Strings for component 'error', language 'pt_br', version '4.5'.
 *
 * @package     error
 * @category    string
...
$string['cannotgeoplugin'] = 'Não é possível conectar o servidor geoPlugin em https://www.geoplugin.com. Verifique suas configurações de proxy ou instale o arquivo de dados MaxMind GeoIP City.';
...
$string['cannotmarktopic'] = 'Não foi possível marcar aquela seção para este curso';
...
$string['cannotsaveagreement'] = 'Não foi possível salvar sua concordância';
$string['cannotsaveblock'] = 'Erro ao salvar a configuração do bloco';
$string['cannotsavecomment'] = 'Não foi possível salvar o comentário';
$string['cannotsavedata'] = 'Não foi possível salvar os dados';
$string['cannotsavefile'] = 'Não é possível salvar o arquivo "{$a}"!';
...
$string['dmlwriteexception'] = 'Erro ao escrever na base de dados';
...
$string['emailfail'] = 'O envio de e-mail falhou';
...
$string['invalidfile'] = 'Arquivo não encontrado';
...
$string['moodlenet:invalidshareformat'] = 'Formato de compartilhamento MoodleNet incorreto';
$string['moodlenet:invalidsharestatus'] = 'Status de compartilhamento MoodleNet incorreto';
$string['moodlenet:invalidsharetype'] = 'Tipo de compartilhamento MoodleNet inválido';
...
$string['opensslsealerror'] = 'OpenSSL incapaz de proteger os dados';
$string['opensslsignerror'] = 'OpenSSL incapaz de assinar dados';
$string['orderidnotfound'] = 'ID do pedido {$a} não encontrado';
$string['pagenotexist'] = '<p>Aconteceu um erro incomum ao tentar ver uma página que não existe:</p>{$a}';
$string['pagenotexisttitle'] = 'Erro 404: Arquivo não encontrado';
$string['passwordexceeded'] = 'A senha não pode ter mais que {$a} caracteres.';
...
$string['pluginnotexist'] = 'O plugin {$a} não existe';
...
';
$string['redissessionhandlerproblem'] = 'Falha na configuração da sessão do redis. Por favor, notifique o administrador do servidor.';
...
$string['sectioncantbefound'] = '<p><strong>Este conteúdo não foi encontrado</strong></p><p>Ele pode ter sido excluído ou o URL pode estar incorreto.</p>';
...
$string['unknownhelp'] = 'Seção de ajuda desconhecida {$a}';
...
$string['usernotaddedusernameexists'] = 'Usuário não adicionado - nome de usuário já existe com um e-mail diferente';
