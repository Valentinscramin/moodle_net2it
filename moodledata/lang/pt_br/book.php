...
/**
 * Strings for component 'book', language 'pt_br', version '4.5'.
 *
 * @package     book
 * @category    string
...
$string['book:viewhiddenchapters'] = 'Ver capítulos ocultos de livros';
...
$string['indicator:socialbreadth_help'] = 'Este indicador baseia-se no engajamento social alcançada pelo estudante em um recurso Livro.';
...
$string['removeallbooktags'] = 'Excluir todas as tags do livro';
