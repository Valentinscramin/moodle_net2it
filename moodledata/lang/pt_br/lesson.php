...
/**
 * Strings for component 'lesson', language 'pt_br', version '4.5'.
 *
 * @package     lesson
 * @category    string
...
$string['ongoingcustom'] = 'Você ganhou {$a->score} ponto(s) de um total de {$a->currenthigh} ponto(s) até agora.';
