...
/**
 * Strings for component 'grades', language 'pt_br', version '4.5'.
 *
 * @package     grades
 * @category    string
...
$string['aria-toggledropdown'] = 'Alternar a seguinte lista suspensa';
$string['aria:dropdowngrades'] = 'Itens de nota encontrados';
...
$string['erroroverweight'] = 'O peso total excede 100%.';
...
$string['exportonlyactive_help'] = 'Apenas incluir estudantes na exportação, cuja inscrição está ativa e não foi suspensa';
...
$string['gradevaluetoosmall'] = 'Um dos valores de nota é menor que a nota mínima permitida de {$a}';
...
$string['minmaxtouse_link'] = 'Notas_Mínimas_Máximas';
...
$string['missingitemtypeoreid'] = 'Chave de matriz (itemtype ou eid) ausente';
...
$string['removeallcoursegrades'] = 'Excluir todas as notas';
...
$string['removeallcourseitems'] = 'Excluir todos os itens e categorias';
