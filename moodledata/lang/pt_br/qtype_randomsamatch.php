...
/**
 * Strings for component 'qtype_randomsamatch', language 'pt_br', version '4.5'.
 *
...
$string['privacy:metadata'] = 'O plugin de tipo de questão Associação aleatória de resposta curta não armazena nenhum dado pessoal.';
$string['randomsamatch'] = 'Associação aleatória de resposta curta.';
$string['randomsamatchintro'] = 'Para cada uma das seguintes questões, marque a resposta correspondente no menu.';
$string['randomsamatchnumber'] = 'Número de questões para selecionar';
$string['subcats'] = 'Incluir subcategorias';
$string['subcats_help'] = 'Se marcada, as questões serão também escolhidas a partir de subcategorias.';
