...
/**
 * Strings for component 'enrol_database', language 'pt_br', version '4.5'.
 *
...
$string['newcourseenddate'] = 'Campo de nova data final do curso';
$string['newcourseenddate_desc'] = 'Opcional. Se não for definido, a data de término do curso será definida de acordo com a duração padrão do curso configurada. Se definido, o valor padrão será substituído.';
...
$string['newcoursestartdate'] = 'Campo de nova data inicial do curso';
$string['newcoursestartdate_desc'] = 'Opcional. Se não for definido, a data de início do curso será definida para a data atual. Se for definido, o valor padrão será substituído.';
...
$string['pluginname_desc'] = 'Você pode usar um banco de dados externo (de quase todo tipo) para controlar suas inscrições. Presume-se que o seu banco de dados externo contém pelo menos um campo com a identificação do curso, e outro com a identificação de usuário. Estes campos serão comparados com os campos que você escolher das tabelas locais de curso e de usuário.';
