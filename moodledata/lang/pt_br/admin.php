...
/**
 * Strings for component 'admin', language 'pt_br', version '4.5'.
 *
 * @package     admin
 * @category    string
...
$string['accountlocked'] = 'Sua conta foi bloqueada. Um link de desbloqueio foi enviado para o endereço de e-mail associado à sua conta.';
$string['accounts'] = 'Contas';
$string['accountunlocked'] = 'Sua conta foi desbloqueada com sucesso. Agora você pode fazer o login.';
...
Os backups assíncronos serão habilitados para todos os sites do Moodle LMS 4.5 LTS. Os backups síncronos serão removidos do Moodle LMS na versão posterior à 4.5 LTS';
...
$string['configallowattachments'] = 'Se habilitado, e-mails enviados pelo site podem ter anexos, como "emblemas".';
...
$string['configallowedemaildomains'] = 'Lista domínio de e-mail que são permitidos serem divulgados no campo "De" dos e-mails enviados. O padrão de "Vazio" usará o endereço de no-reply para todos os e-mails enviados. O uso de coringas é permitido, por exemplo: *.exemplo.com permitirá e-mails enviados de qualquer subdomínio de exemplo.com, mas não o próprio exemplo.com. Para isso será necessária uma entrada separada.';
$string['configallowemailaddresses'] = 'Para restringir novos endereços de e-mails para domínios particulares, liste-os aqui separados por espaços. Qualquer outro domínio será rejeitado. Para permitir subdomínios, escreva o domínio precedido por \'.\'. Para permitir um domínio raiz junto com seus domínios, adicione o domínio duas vezes - uma vez precedido de \'.\' e outra sem. Por exemplo: .nossafaculdade.edu.br nossafaculdade.edu.br.';
...
$string['configallowobjectembed'] = 'Como medida padrão de segurança, os usuários em geral não podem incluir multimídia em seus textos usando explicitamente as tags EMBED e OBJECT no seu HTML (embora seja possível o procedimento seguro usando o filtro mediaplugins). Se você deseja permitir essas tags, então habilite esta opção.';
...
$string['configallowusermailcharset'] = 'Ativando isto cada usuário do site poderá escolher o próprio conjunto de caracteres para o e-mail.';
...
$string['configdeleteincompleteusers'] = 'Depois deste período, qualquer conta sem o nome, sobrenome ou campo e-mail preenchidos serão excluídas.';
...
$string['configdocroot'] = 'Define o caminho para o Moodle Docs para fornecer documentação específica para o contexto através dos links \'Documentação para esta página\' no rodapé de cada página. Se o campo for deixado em branco, os links não serão exibidos.';
...
$string['configemailchangeconfirmation'] = 'Exigir confirmação por e-mail quando os usuários mudam o endereço e-mail no perfil.';
$string['configemaildkimselector'] = 'O seletor DKIM é arbitrário e seus registros DNS devem corresponder a ele.';
$string['configemailfromvia'] = 'Adiciona a informação "via" no campo "De" dos e-mails enviados. Isso informa o destinatário de onde este e-mail veio e também ajuda a prevenir destinatários de responder endereços de e-mail no-reply.';
$string['configemailheaders'] = 'Cabeçalhos de e-mail brutos a serem adicionados literalmente a todos os e-mails de saída.';
$string['configemailsubjectprefix'] = 'Texto a ser prefixado na linha de assunto de todos os e-mails de saída.';
...
$string['configgeoipfile'] = 'Caminho do arquivo binário de dados do GeoIP City. Este arquivo não faz parte da distribuição do Moodle e deve ser obtido separadamente em <a href="https://www.maxmind.com/">MaxMind</a>. Você pode comprar uma versão comercial ou usar a versão gratuita. Será necessário se registrar para baixar o arquivo do banco de dados City, o que pode ser feito em <a href="https://dev.maxmind.com/geoip/geoip2/geolite2/" >https://dev.maxmind.com/geoip/geoip2/geolite2/</a>. Depois de se registrar e baixar o arquivo, extraia-o no diretório "{$a}" em seu servidor.';
...
$string['configgradeexportdefault'] = 'Escolha qual o formato de exportação do livro de notas é seu método padrão para exportá-las.';
...
$string['configmailnewline'] = 'Caracteres de nova linha utilizados em mensagens de e-mail. CRLF é obrigatório de acordo como RFC822bis, alguns servidores de e-mail fazem a conversão automática de LF para CRLF, outros servidores de e-mail fazem a conversão incorreta de CRLF para CRCRLF, e outros ainda rejeitam e-mails só com LF (qmail por exemplo). Tente mudar esta configuração caso você esteja tendo problemas com e-mails não enviados ou linhas em branco a mais.';
...
$string['configmessagingallowemailoverride'] = 'Permite que usuários que encaminhem notificações de mensagens por e-mail para outro e-mail além do e-mail que consta no perfil.';
...
$string['configservicespage'] = 'Digite a URL de uma página de serviços e suporte ou deixe em branco para vincular aos serviços do Moodle em moodle.com. O link é exibido apenas para administradores do site.';
...
$string['configsitemailcharset'] = 'Todos os e-mails criados pelo site utilizarão o conjunto de caracteres aqui definido. Para que os usuários possam personalizar esta configuração é necessário ativar a próxima opção.';
...
$string['configsmtphosts'] = 'Indicar o endereço completo de um ou mais servidores SMTP locais que o Moodle deve utilizar para o envio de correio eletrônico (por exemplo: \'mail.a.com\' or \'mail.a.com;mail.b.com\'). Se deixar em branco, o Moodle usará o método PHP padrão de envio de e-mail.';
...
$string['configsupportemail'] = 'Se o SMTP está configurado neste site a uma página de suporte não está definida, esse endereço de e-mail irá receber mensagens enviadas através do formulário de suporte. Se o envio falhar, esse endereço de e-mail será exibido aos usuários logados.';
...
$string['configverifychangedemail'] = 'Habilita a verificação de endereços de e-mails alterados utilizando as configurações de domínios autorizados e proibidos. Se esta configuração for desabilitada, esta restrição será aplicada apenas na criação de novos usuários';
...
$string['cron_keepalive_desc'] = 'O período de tempo para manter a sondagem de tarefas adicionais. Essa configuração é para garantir que o cron esteja sempre em execução. Se você usar executores de tarefas dedicados, defina-o como 0. Caso contrário, defina-o como um valor semelhante ao limite de simultaneidade de tarefas ad hoc. Evite tempos mais longos. O tempo máximo é de 15 minutos.';
...
$string['debugtemplateinfo_desc'] = 'Se habilitado, os templates usados para renderização são mostrados como comentários na página HTML. Depois de alterar a configuração, você precisa limpar os caches. Use apenas para depuração temporária, pois produz erros de validação de HTML e pode interromper alguns scripts de página.';
...
$string['deleteduserx'] = 'Usuário excluído {$a}';
...
$string['denyemailaddresses'] = 'Domínios de e-mails proibidos';
...
$string['divertallemails'] = 'Desvio de e-mails';
$string['divertallemailsdetail'] = 'Usado como proteção em ambientes de desenvolvimento ao testar e-mails e não deve ser usado na produção.';
$string['divertallemailsexcept'] = 'Exceções de desvio de e-mails';
...
$string['divertallemailsto'] = 'Redirecionar todos os e-mails';
$string['divertallemailsto_desc'] = 'Se ativado, todos os e-mails serão redirecionados para este único endereço de e-mail.';
...
$string['doesnotfit'] = 'Configuração de exibição de e-mail';
...
$string['emailchangeconfirmation'] = 'Confirmação de mudança de e-mail';
$string['emaildkim'] = 'Assinatura de e-mails com DomainKeys Identified Mail (DKIM)';
...
$string['emailsubjectprefix'] = 'Prefixo do texto do assunto do e-mail';
...
$string['enablecommunicationsubsystem'] = 'Habilitar provedores de comunicação';
$string['enablecommunicationsubsystem_desc'] = 'Permita a integração com provedores de comunicação como o Matrix para que professores e estudantes possam se comunicar com mais facilidade. Você pode gerenciar essas integrações em <a href="settings.php?section=managecommunicationproviders">Plugins</a>.';
...
$string['geoipdbedition_desc'] = 'Selecione a edição do banco de dados GeoIP para download. Tenha ciência de que o uso do banco de dados GeoIP2-City requer uma licença paga válida.';
$string['geoipfile'] = 'Arquivo GeoIP City DB';
$string['geoipmaxmindaccid'] = 'ID da conta MaxMind.';
$string['geoipmaxmindaccid_desc'] = 'O ID da conta criada no serviço API MaxMind.';
$string['geoipmaxmindlicensekey'] = 'Chave de licença MaxMind';
$string['geoipmaxmindlicensekey_desc'] = 'A chave de licença da conta criada no serviço API MaxMind.';
...
$string['gradeexportdefault'] = 'Método padrão de exportação de notas';
...
$string['hookcallbacknotcallable'] = 'Este retorno de chamada não pode ser chamado. Isso pode ocorrer porque a classe ou método não existe ou porque o método não é público.';
$string['hookcallbacks'] = 'Callbacks';
$string['hookcallbacks_help'] = 'A lista de retornos de chamada que serão chamados quando o hook for despachado.

A ordem mostrada é a ordem em que os retornos de chamada são chamados.

Um retorno de chamada com prioridade mais alta será chamado antes de outro com prioridade mais baixa.';
$string['hookclassmissing'] = 'Classe de hook não encontrada';
$string['hookclassmissing_desc'] = 'O agente de detecção de hook retornou uma classe que não existe.';
$string['hookconfigoverride'] = 'Sobreposto';
$string['hookconfigoverride_help'] = 'A definição deste retorno de chamada foi substituída no arquivo de configuração do site, config.php';
$string['hookdeprecates'] = 'Callbacks obsoletas do lib.php';
$string['hookdescription'] = 'Descrição';
$string['hookdescriptionmissing'] = 'O hook não possui um método de descrição';
$string['hookname'] = 'Hook';
$string['hooksoverview'] = 'Visão geral dos hooks';
$string['hookunknown'] = 'Hook não encontrado';
$string['hookunknown_desc'] = 'O objeto que este retorno de chamada atende não está disponível. Pode ter sido removido ou renomeado, ou pode não estar disponível nesta versão do Moodle.';
...
$string['importantupdates_content'] = '<p>No próximo Moodle 5.0, planejado para lançamento em abril de 2025, as atividades Chat e Pesquisa
serão removidas do núcleo do Moodle. Elas estarão disponíveis como plugins no
<a href="https://moodle.org/plugins/">diretório de plugins do Moodle</a>.</p>
<p>Se você deseja continuar usando Chat ou Pesquisa em seu site, poderá instalá-los como plugins antes de atualizar para o Moodle 5.0.</p>';
$string['importantupdates_title'] = 'Atualização importante sobre as atividades Chat e Pesquisa';
...
$string['iplookupgeoplugin'] = 'O serviço <a href="https://www.geoplugin.com">geoPlugin</a> está atualmente sendo usado para buscar informações geográficas. Para obter resultados mais precisos, recomendamos a instalação de uma cópia local da base de dados MaxMind GeoIP City.';
$string['iplookupinfo'] = 'O servidor online gratuito NetGeo é usado para procurar localizações de endereços IP. O banco de dados não é mais mantido e pode retornar dados incorretos. Recomenda-se a instalação de uma cópia local do banco de dados GeoIP da MaxMind.<br />
...
$string['iplookupmaxmindnote'] = 'Esse produto inclue dados GeoIP City criados por MaxMind, disponível em <a href="http://www.maxmind.com">https://www.maxmind.com</a>.';
...
$string['lockoutemailbody'] = 'Oi {$a->firstname},

Sua conta com nome de usuário {$a->username} em \'{$a->sitename}\' foi bloqueada após várias tentativas de login inválidas.

Para desbloquear a conta, vá para o seguinte endereço

{$a->link}

Na maioria dos programas de e-mail, esta deve aparecer como um link azul que você pode simplesmente clicar. Se isso não funcionar, copie e cole o endereço na barra de endereços no topo da janela do seu navegador.
...
$string['mailnewline'] = 'Caracteres de nova linha no e-mail';
...
$string['messagingallowemailoverride'] = 'Sobreescreve notificações por e-mail';
...
$string['noemaileverwarning'] = '<strong>Observação:</strong> todos os e-mails enviados foram desativados';
...
$string['notifyloginfailures'] = 'E-mail de falhas de login';
$string['notifyloginthreshold'] = 'Limite de notificações por e-mail';
...
$string['oracledatabaseinuse'] = 'O suporte ao banco de dados Oracle será removido. A versão do Moodle 4.5 será a última versão com suporte ao Oracle. Mais informações podem ser encontradas <a href="https://moodle.org/mod/forum/discuss.php?d=456122" target="_blank">aqui</a>.';
...
$string['perfdebugdeferred'] = 'Aguardando até o script terminar para mostrar a depuração de desempenho...';
...
$string['registrationwarning'] = 'Seu site ainda não está registrado. Não perca atualizações importantes e alertas de segurança.';
$string['registrationwarningcontactadmin'] = 'Este site não está registrado. Solicite ao seu administrador registrar o site para não perder atualizações importantes.';
...
';
$string['sessioncookie'] = 'Sufixo do Cookie';
...
$string['sitesectionhelp'] = 'Exibir uma seção no topo da página onde você pode adicionar conteúdo personalizado.';
...
$string['smallscreensonly'] = 'Somente telas pequenas';
$string['smtp'] = 'SMTP';
...
$string['supportemail'] = 'E-mail de suporte';
...
$string['task_adhoc_failed_retention'] = 'Período de retenção de tarefa ad hoc falha';
$string['task_adhoc_failed_retention_desc'] = 'O período máximo que as tarefas ad hoc falhas devem permanecer na fila após atingirem seu limite de tentativas de falhas.';
...
$string['taskautomatedbackup_report'] = 'Relatório de backups automatizados';
$string['taskbackupcleanup'] = 'Limpar tabelas, logs e arquivos de backup';
$string['taskbadgesadhoc'] = 'Conceder emblema';
$string['taskbadgescron'] = 'Adicionar tarefas ad hoc para conceder emblemas';
...
$string['taskupdategeoip2file'] = 'Atualizar arquivo GeoIP';
...
$string['testoutgoingmailconf_fromemail'] = 'Do nome de usuário ou endereço de e-mail';
...
$string['testoutgoingmailconf_fromemail_invalid'] = 'Nome de usuário ou e-mail inválido. O remetente deve ser um formato de e-mail válido ou um nome de usuário existente no Moodle.';
$string['testoutgoingmailconf_message'] = 'Esta é uma mensagem de teste para confirmar que você configurou corretamente a saída de e-mail do seu site. Enviado: {$a}';
$string['testoutgoingmailconf_sendtest'] = 'Enviar uma mensagem de teste';
$string['testoutgoingmailconf_sentmail'] = 'Este site enviou com sucesso uma mensagem de teste para o servidor de e-mail. <br /> De: {$a->fromemail} <br /> Para: {$a->toemail}';
...
$string['testoutgoingmailconf_toemail'] = 'Para endereço de e-mail';
...
$string['themedefinedinconfigphp'] = 'O tema não pode ser alterado porque está definido como {$a} em config.php.';
...
$string['themeeditsettingsname'] = 'Editar configurações do tema \'{$a}\'';
...
$string['themesettingsadvanced'] = 'Configurações avançadas de tema';
$string['themesettingscustom'] = 'Configurações de tema personalizado';
$string['themesettingsname'] = 'Configurações do tema \'{$a}\'';
$string['themeusagereportname'] = 'Relatório de uso do tema \'{$a}\'';
...
$string['userfeedbackencouragement'] = '<p>O Moodle tem uma funcionalidade que permite aos usuários a opção de fornecer feedback sobre o software Moodle ao Moodle HQ via site de pesquisa externo hospedado pelo Moodle HQ. Nenhuma informação de identificação do usuário é encaminhada para o site de pesquisa.</p>
...
$string['userfiltersdefault_desc'] = 'Selecione os filtros que devem ser mostrados na página \'Lista de usuários\' e na página \'Ações em lote com usuários\'. Mantenha pressionada a tecla Ctrl para selecionar vários itens. Os filtros não selecionados ainda estarão disponíveis através do link "Mostrar mais"';
...
$string['verifychangedemail'] = 'Restringir domínios quando na alteração do endereço de e-mail';
