...
/**
 * Strings for component 'message_airnotifier', language 'pt_br', version '4.5'.
 *
...
$string['encryptnotifications_help'] = 'Habilitar a criptografia de ponta a ponta das notificações do aplicativo. Alguns dados podem ser removidos da notificação se não puderem ser criptografados.';
$string['encryptprocessing'] = 'Para dispositivos que não suportam criptografia';
$string['encryptprocessing_desc'] = 'As notificações criptografadas requerem pelo menos o Android 8 ou o iOS 13 e o Moodle App 4.2 ou posterior.';
