...
/**
 * Strings for component 'qbehaviour_deferredcbm', language 'pt_br', version '4.5'.
 *
...
$string['cbmgrades_help'] = 'Com Certainty Based Marking (CBM) cada questão ficará correta com C = 1 (baixa certeza) atribuindo uma nota de 100%. As escalas podem ser tão elevadas como 300%, se todas as questões estão corretas com C = 3 (alta certeza). Equívocos (respostas erradas) escalas muito mais inferiores do que as respostas erradas que são reconhecidas como incertas. Isso pode até mesmo levar a escalas negativas globais.
...
$string['privacy:metadata'] = 'O plugin de comportamento de questão Comentários adiados com CBM não armazena nenhum dado pessoal.';
