...
/**
 * Strings for component 'forum', language 'pt_br', version '4.5'.
 *
 * @package     forum
 * @category    string
...
$string['announcementsettings'] = 'Configurações padrão do fórum de anúncios';
$string['announcementsettings_help'] = 'Essas configurações definem os padrões para todos os fóruns de anúncios.';
...
$string['authorreplyingprivatelytoauthor'] = '{$a->respondant} respondendo privadamente a {$a->author}';
...
$string['cachedef_forum_count_discussions'] = 'Contagem de discussões no fórum';
...
$string['cannotviewusersposts'] = 'Não há posts deste usuário que você seja capaz de ver.';
...
$string['completiondiscussions'] = 'O usuário deve iniciar discussões';
...
$string['completionposts'] = 'O estudante deve iniciar ou responder um tópico de discussão';
...
$string['configdigestmailtime'] = 'Quem escolher esta opção receberá todas as mensagens do fórum agrupadas em um resumo diário. Esta opção controla a hora do dia que o e-mail diário será enviado (o primeiro cron depois deste horário fará o envio).';
...
$string['configreplytouser'] = 'Quando as mensagens dos fóruns são enviadas aos usuários via e-mail devem conter o endereço do autor para que seja possível responder via e-mail diretamente a ele sem passar pelo fórum? Mesmo quando a opção escolhida for "sim" os usuários terão a possibilidade de mudar o perfil pessoal deles para manter o endereço de e-mail escondido.';
...
$string['digestmailheader'] = 'Este é o resumo diário das novas mensagens dos fóruns de {$a->sitename}. Para alterar suas preferências sobre o e-mail de mensagens do fórum, acesse {$a->userprefs}.';
...
$string['digestmailtime'] = 'Horário de envio do resumo de e-mails';
$string['digestsentusers'] = 'E-mail de resumos enviados com sucesso para {$a} usuários.';
...
$string['emaildigesttype'] = 'Opções de alertas de e-mail';
...
$string['eventdiscussionlockupdated'] = 'Bloqueio de discussão atualizado';
...
$string['eventforumsubscriptionupdated'] = 'Modo de assinatura atualizado';
...
$string['forum:canmailnow'] = 'Pode postar no fórum de perguntas e respostas sem atraso no tempo de edição';
...
$string['indicator:cognitivedepthdef_help'] = 'O participante alcançou este percentual de engajamento cognitivo oferecido pelas atividades Fórum durante este intervalo de análise (Níveis = Nenhuma visualização Visualizado, Envio, Feedback visualizado, Comentários ao feedback, Submeter novamente após ver feedback)';
...
$string['invaliddigestsetting'] = 'Uma configuração de resumo de e-mail inválida foi fornecida';
...
$string['postisprivatereply'] = 'Esta é uma resposta privada. (Somente professores e outros usuários com a permissão de ver respostas privadas podem vê-la.)';
...
$string['privatereply_help'] = 'Quando você responde de forma privada, sua mensagem fica visível também para os usuários com permissão de ver respostas privadas, como os professores.';
...
$string['removeallforumtags'] = 'Excluir todas as tags do fórum';
...
$string['replytouser'] = 'Usar endereço e-mail na resposta';
$string['resetdigests'] = 'Excluir todas as preferências de resumo do fórum por usuário';
$string['resetforums'] = 'Excluir as mensagens de';
$string['resetforumsall'] = 'Excluir todas as mensagens';
$string['resetsubscriptions'] = 'Excluir todas as assinaturas no fórum';
...
$string['subplugintype_forumreport'] = 'Relatório do fórum';
$string['subplugintype_forumreport_plural'] = 'Relatórios do fórum';
...
$string['unsubscribeall'] = 'Suspender o recebimento de mensagens de todos os fóruns via e-mail';
...
$string['unsubscribed'] = 'Cancelado o recebimento de cópias das mensagens via e-mail';
