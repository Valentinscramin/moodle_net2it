...
/**
 * Strings for component 'badges', language 'pt_br', version '4.5'.
 *
 * @package     badges
 * @category    string
...
$string['activatesuccess'] = 'Acesso ao emblema "{$a}" habilitado.';
...
$string['awardoncron'] = 'Um grande número de usuários está recebendo o emblema "{$a->badgename}". Pode levar algum tempo para que todos os usuários o recebam.';
...
$string['backpackexporterrorwithinfo'] = 'Não é possível exportar o emblema "{$a->badgename}" para a mochila. Erro: {$a->error}';
...
$string['contact'] = 'Contato do emissor';
...
$string['deactivatesuccess'] = 'Acesso ao emblema "{$a}" desabilitado.';
...
$string['error:notifycoursedate'] = 'Aviso: Emblemas associados com as conclusões de atividade e curso não serão emitidos até a data de início do curso ({$a}).';
...
$string['newbadgedeprecated'] = 'Você foi redirecionado de badges/newbadge.php. Por favor, note que badges/newbadge.php será removido em um futuro próximo.
<br/>Atualize links e favoritos para usar a página atual badges/edit.php.';
...
$string['nomatchingawards'] = 'Não há destinatários correspondentes que tenham ganhado este emblema ainda';
$string['nomatchingbadges'] = 'Não há emblemas correspondentes disponíveis para os usuários ganharem';
...
$string['numawards'] = 'Usuários que receberam o emblema "{$a->badgename}": <a href="{$a->link}">{$a->count}</a>.';
$string['numawardstat'] = 'Usuários que receberam o emblema "{$a->badgename}": {$a->awards}.';
