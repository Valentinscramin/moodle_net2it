...
/**
 * Strings for component 'customcert', language 'pt_br', version '4.5'.
 *
 * @package     customcert
 * @category    string
...
$string['alignment_help'] = 'Esta propriedade define o alinhamento horizontal do elemento. Alguns elementos podem não suportar isto, enquanto o comportamento de outros pode ser diferente.';
...
$string['customcert:managelanguages'] = 'Gerenciar idioma no formulário de edição';
...
$string['downloadallissuedcertificates'] = 'Faça o download de todos os certificados emitidos.';
$string['downloadallsitecertificates'] = 'Faça o download de todos os certificados do site.';
$string['downloadallsitecertificatesdesc'] = 'Isso fará o download de todos os certificados do site em um arquivo zip.';
...
$string['elementheight_help'] = 'Defina a altura do elemento. Se definida como \'0\',  a altura será calculada automaticamente.';
...
$string['elementwidth_help'] = 'Defina a largura do elemento. Se definida como \'0\', a largura será calculada automaticamente.';
...
$string['eventelementdeleted'] = 'Elemento de certificado personalizado excluído';
...
$string['eventpagedeleted'] = 'Página de certificado personalizado excluída';
...
$string['eventtemplatedeleted'] = 'Modelo de certificado personalizado excluído';
...
$string['invalidelementwidthorheightnotnumber'] = 'Digite um número válido.';
...
$string['userlanguage'] = 'Usar as preferências do usuário';
$string['userlanguage_help'] = 'Você pode forçar o idioma do certificado a substituir as preferências de idioma do usuário.';
