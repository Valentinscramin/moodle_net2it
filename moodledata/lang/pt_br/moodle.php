...
/**
 * Strings for component 'moodle', language 'pt_br', version '4.5'.
 *
 * @package     moodle
 * @category    string
...
$string['addfilesdrop'] = 'Para fazer upload, você pode arrastar e soltar os arquivos aqui ou clicar para selecionar os arquivos.';
...
$string['backupinfo'] = 'Fazer uma cópia deste curso, incluindo todo o conteúdo e atividades atualizados. Você pode usar o arquivo de backup para restaurar este curso.';
...
$string['bulkmovecoursessuccess'] = 'Os cursos {$a->courses} foram movidos para a {$a->category} com sucesso';
...
$string['checkerror'] = 'Erro ao obter o resultado da verificação \'{$a}\'. Verifique o console do navegador para obter mais informações.';
...
$string['checkloading'] = 'Obter o resultado da verificação \'{$a}\'';
...
$string['contentexport_viewfilename'] = 'Ver o arquivo {$a}';
...
$string['courseapprovedemail'] = 'O seu pedido de solicitação do curso {$a->name} foi aprovado e você foi inscrito como {$a->teacher}.';
$string['courseapprovedemail2'] = 'Seu curso solicitado, {$a->name}, foi aprovado:  <a href="{$a->url}">{$a->name}</a>.';
...
$string['coursereasonforrejectingemail'] = 'Isto será enviado por e-mail para o solicitante';
...
{$a}';
$string['courserejectreason'] = 'Descreva as razões para rejeitar este curso<br />(uma cópia será mandada por e-mail ao autor do pedido)';
...
$string['courserequestroleerror'] = 'O papel dos criadores na configuração de novos cursos é inválida. Consulte as <a href="{$a}">políticas do usuário</a>.';
$string['courserequestsuccess'] = 'Sua solicitação de curso foi realizada com sucesso. Será enviado um e-mail para você informando se sua solicitação foi aprovada.';
$string['courserequestsupport'] = 'Informações adicionais para ajudar o administrador a avaliar esta solicitação';
$string['courserequestwarning'] = 'O usuário que solicitar inscrição neste curso assumirá automaticamente o papel "{$a}".';
$string['courserestore'] = 'Restauração de curso';
$string['coursereuse'] = 'Reutilizar curso';
$string['coursereusenavigationmenu'] = 'Menu de navegação de reutilização de curso';
...
$string['coursesectiontitlebulkediting'] = 'Editar em lote {$a->sectionname}: {$a->sectiontitle} | {$a->course}';
...
$string['coursetitlebulkediting'] = 'Edição em massa do curso: {$a->course}';
...
$string['editsectionsettings'] = 'Editar configurações da seção';
$string['editsectiontitle'] = 'Editar seção: {$a}';
...
$string['emailactive'] = 'E-mail ativado';
...
$string['emailcharset'] = 'E-mail charset';
$string['emailconfirm'] = 'Confirmar seu registro';
$string['emailconfirmation'] = 'Oi {$a->firstname},

Uma nova conta foi criada em \'{$a->sitename}\' usando seu endereço de e-mail.

Para confirmar sua nova conta acesse o seguinte endereço:

{$a->link}

Na maioria do programas de E-mail isso deve aparecer como um link azul que você pode simplesmente clicar. Se isto não funcionar, você pode copiar este link e colar na barra de endereços do seu navegador.
...
$string['emailconfirmsentfailure'] = 'O e-mail de confirmação não foi enviado';
$string['emailconfirmsentsuccess'] = 'E-mail de confirmação enviado com sucesso';
$string['emaildigest'] = 'Tipo de resumo de e-mail';
...
$string['emaildigestcomplete'] = 'Completo (um e-mail diário com as mensagens completas dos fóruns)';
$string['emaildigestoff'] = 'Sem resumo (um e-mail para cada mensagem do fórum)';
$string['emaildigestsubjects'] = 'Assuntos (um e-mail diário, apenas com os assuntos das mensagens)';
$string['emaildisable'] = 'Este endereço de e-mail não está ativado';
$string['emaildisableclick'] = 'Clique aqui para desabilitar o envio de e-mails para este endereço';
$string['emaildisplay'] = 'Visibilidade de e-mail';
$string['emaildisplay_help'] = '* Oculto - Somente usuários com permissões adequadas, como professores, podem ver seu endereço de e-mail.
* Visível para todos - Todos os usuários do site podem ver seu endereço de e-mail.
* Visível para os participantes do curso - Somente os participantes dos cursos que você está inscrito podem ver seu endereço de e-mail.';
...
$string['emailenable'] = 'Este endereço de e-mail está ativado';
$string['emailenableclick'] = 'Clique aqui para habilitar novamente o envio de e-mail para este endereço';
$string['emailexists'] = 'Este endereço de e-mail já foi registrado.';
...
$string['emailmustbereal'] = 'Aviso: o seu endereço de e-mail deve ser verdadeiro';
$string['emailnotallowed'] = 'Endereços de e-mail destes domínios não são aceitos ({$a})';
$string['emailnotfound'] = 'O endereço e-mail não foi encontrado na base de dados';
...
Recebemos uma solicitação para redefinir a senha da sua conta "{$a->username}" em "{$a->sitename}". Se você não foi o responsável por essa solicitação, recomendamos que entre em contato com o administrador {$a->admin} para que ele possa tomar as medidas necessárias.

Para criar uma nova senha, por favor, acesse o seguinte link:

{$a->link}

Caso tenha alguma dúvida ou precise de assistência, não hesite em entrar em contato com o administrador do site, {$a->admin}.

Atenciosamente,
{$a->admin}';
$string['emailpasswordchangeinfodisabled'] = 'Olá {$a->firstname},

Recebemos um pedido de redefinição de senha para sua conta em \'{$a->sitename}\'. Se você não foi o responsável por essa solicitação, entre em contato com o administrador {$a->admin}.

Infelizmente, sua conta neste site está desativada, e por isso a senha não pode ser redefinida. Entre em contato com o administrador do site {$a->admin}.';
$string['emailpasswordchangeinfofail'] = 'Olá {$a->firstname},

Recentemente, recebemos um pedido para redefinir a senha da sua conta em \'{$a->sitename}\'. Se você não foi o responsável por essa solicitação,  entre em contato com o administrador {$a->admin}.

No entanto, neste site não é possível modificar senhas diretamente. Por favor, entre em contato com o administrador {$a->admin}.';
$string['emailpasswordchangeinfosubject'] = '{$a}: Solicitação de Redefinição de Senha';
...
Para confirmar este pedido e receber a nova senha via E-mail, vá ao seguinte endereço web:

{$a->link}

Na maioria do programas de E-mail este é um link azul que você pode ativar clicando em cima.
...
$string['emailpasswordconfirmmaybesent'] = '<p>Se o nome de usuário ou o e-mail estiverem corretos, um e-mail deve ter sido enviado a você.</p>
<p>Este e-mail contém instruções simples para confirmar e completar a alteração de senha.
...
$string['emailpasswordconfirmsent'] = '<p>Um e-mail será enviado para o seu endereço: <b>{$a}</b>.</p> <p>Siga as instruções contidas no e-mail para completar a mudança de senha. Em caso de dificuldades contate o administrador do site.</p><p>Caso você não veja este e-mail na sua caixa de entrada, por favor, procure por ele na pasta de lixo eletrônico.</p>';
$string['emailpasswordsent'] = '<p>Um e-mail com a sua nova senha foi enviada ao seguinte endereço: <b>{$a->email}</b>.</p>
...
$string['emailresetconfirmsent'] = 'Uma mensagem foi enviada para o e-mail de <b>{$a}.</b> <br /> Ele contém instruções fáceis para confirmar e completar esta alteração de senha. Se você continuar a ter dificuldades, contate o administrador do site.';
...
$string['enddate_help'] = 'A data de término não restringe o acesso do estudante ao curso. Determina se um curso está listado como Passado em Meus cursos.';
$string['enddatewithtaskenabled'] = 'Curso e data';
$string['enddatewithtaskenabled_help'] = 'A data que o curso fica oculto para os estudantes e eles não podem mais acessá-lo.';
...
$string['enteremailaddress'] = 'Escreva o seu endereço de e-mail para reconfigurar a sua senha e recebê-la via correio eletrônico.';
...
$string['errorwhenconfirming'] = 'Não foi possível completar a confirmação. Se você chegou aqui a partir de um link em um e-mail, pode ser que a linha de endereço do link tenha sido alterada pelo programa de correio eletrônico. Neste caso, tente copiar o link inteiro e colocar na barra de endereços de um navegador para que o percurso seja reconstruído de modo correto.';
...
$string['eventcourseresetended'] = 'Redefinição do curso finalizada';
...
$string['eventsectionviewed'] = 'Seção visualizada';
$string['eventunknownlogged'] = 'Evento desconhecido';
$string['eventurlblocked'] = 'URL foi bloqueado';
...
$string['failedtaskcontexturlname'] = 'Relatório de status';
$string['failedtasksubject'] = 'Tarefa falhou: {$a}';
...
$string['forgottenduplicate'] = 'Este endereço e-mail é compartilhado por diversas contas, por favor digite o usuário';
...
* Atividade única - O curso contém apenas uma atividade ou recurso (como um Quiz ou um pacote SCORM) na página do curso
* Social - O curso é centralizado em um fórum principal na página do curso. Atividades e recursos podem ser adicionados usando o bloco Atividades sociais.
* Tópicos - A página do curso é organizada em seções personalizáveis.
* Semanal - A página do curso é organizada em seções semanais, com a primeira semana começando na data de início do curso';
...
$string['go'] = 'Ok';
$string['gobacktosite'] = 'Volte para o site';
$string['gpl'] = 'Copyright (C) 1999 em diante Martin Dougiamas (https://moodle.com)
...
Este programa é distribuído na esperança que possa ser útil, mas SEM QUALQUER GARANTIA; sem mesmo a garantia implícita de COMERCIALIZAÇÃO ou ADEQUAÇÃO PARA UM DETERMINADO PROPÓSITO.

Veja a página sobre a Licença do Moodle para informações mais detalhadas: https://moodledev.io/general/license';
$string['gpl3'] = 'Copyright (C) 1999 em diante Martin Dougiamas (https://moodle.com)
...
Este programa é distribuído na esperança de que seja útil, mas SEM QUALQUER GARANTIA; mesmo sem a garantia implícita de COMERCIALIZAÇÃO ou ADEQUAÇÃO A UM DETERMINADO FIM.

Consulte a página de informações da licença Moodle para detalhes completos: https://moodledev.io/general/license';
...
$string['hiddensections_help'] = 'As seções ocultas podem ser exibidas aos estudantes como “não disponíveis” na página do curso ou mantidas completamente ocultas.';
...
$string['idnumbercourse_help'] = 'Usado apenas para conectar o curso com sistemas externos. Deixe em branco se você não tiver um ID oficial do curso.';
...
$string['importinfo'] = 'Importe itens de outros cursos, como atividades, blocos ou eventos de calendário. Nenhum dado do usuário será importado.';
...
$string['indicator:potentialcognitivedef_link'] = 'Indicadores_de_Análise_de_Aprendizagem#Profundidade_Cognitiva';
...
$string['makeavailablecmtitle'] = 'Disponibilizar atividade';
...
$string['markedthistopic'] = 'Esta seção está destacada como a seção atual';
$string['markthistopic'] = 'Destacar esta seção como a seção atual';
...
$string['messageprovider:enrolcoursewelcomemessage'] = 'Mensagem de boas-vindas para novas inscrições no curso';
...
$string['messageprovider:failedtaskmaxdelay'] = 'A tarefa atinge seu atraso máximo de falha';
...
$string['missingemail'] = 'Está faltando o endereço de e-mail';
...
$string['moodlenet:columnsendstatus'] = 'Status do envio';
...
$string['moodlenet:deletedactivity'] = 'Atividade excluída';
$string['moodlenet:deletedcourse'] = 'Curso excluído';
...
$string['moodlenet:nosharedresources'] = 'Não há recursos compartilhados para exibir neste momento.';
...
$string['moodlenet:sharenoticeactivity'] = 'Esta atividade está sendo compartilhada com o MoodleNet como um recurso.';
$string['moodlenet:sharenoticecourse'] = 'Este curso está sendo compartilhado com o MoodleNet como um recurso.';
$string['moodlenet:sharenoticepartial'] = 'As atividades selecionadas estão sendo compartilhadas com o MoodleNet como recurso.';
$string['moodlenet:sharenoticepartialactivitynumber'] = '{$a} atividades serão incluídas no curso.';
$string['moodlenet:shareprogress'] = 'MoodleNet compartilha progresso';
$string['moodlenet:shareprogressinfo'] = 'A lista mostra cursos e atividades que você compartilhou no MoodleNet.<br>Clique no nome do recurso para ver no MoodleNet.';
...
$string['newpasswordfromlost'] = '<strong>AVISO:</strong> A sua <strong>senha atual</strong> será enviada no <strong>segundo</strong> dos dois e-mails emitidos neste processo de recuperação de senha. Certifique-se que você recebeu a senha substituta antes de continuar.';
$string['newpasswordtext'] = 'Olá, {$a->firstname},

Sua senha no site \'{$a->sitename}\' foi redefinida com sucesso. Abaixo estão suas novas credenciais de acesso temporárias:

Nome de usuário: {$a->username}
Senha provisória: {$a->newpassword}

Para garantir a segurança de sua conta, por favor, acesse o link abaixo e altere sua senha o mais rápido possível:
{$a->link}

Se precisar de qualquer assistência, não hesite em nos contatar.

Atenciosamente,
Equipe de administração de {$a->sitename}
{$a->signoff}';
...
$string['newusernewpasswordsubj'] = 'Sua nova conta foi criada!';
$string['newusernewpasswordtext'] = 'Olá {$a->firstname},

Uma nova conta foi criada para você em \'{$a->sitename}\' e você recebeu uma nova senha temporária.

Suas informações de login são:
   Usuário: {$a->username}
   Senha: {$a->newpassword}
             (você precisará alterar sua senha quando fizer login pela primeira vez)

Para começar a usar \'{$a->sitename}\', faça login em:
   {$a->link}

Se precisar de ajuda, você pode entrar em contato com o administrador do site,
{$a->admin}';
...
$string['nosuchemail'] = 'Este endereço de e-mail não foi encontrado';
...
$string['passwordforgotteninstructions'] = 'Os seus dados devem ser encontrados na base de dados. Por favor, digite <strong>somente</strong> seu usuário ou endereço de e-mail registrado na caixa apropriada. Não há necessidade de introduzir ambos.';
$string['passwordforgotteninstructions2'] = 'Para redefinir sua senha, preencha seu usuário ou seu e-mail abaixo. Se sua conta for encontrada no banco de dados, um e-mail será enviado para seu endereço de e-mail, com as instruções sobre como restabelecer seu acesso.';
...
$string['passwordsenttext'] = '<p>Uma mensagem contendo a sua nova senha foi enviada ao endereço {$a->email}.</p>
...
$string['previewthemename'] = 'Ver prévia do tema \'{$a}\'';
...
$string['privacy:metadata:moodlenet_share_progress'] = 'MoodleNet compartilha detalhes do progresso';
$string['privacy:metadata:moodlenet_share_progress:cmid'] = 'O ID do módulo do curso associado';
$string['privacy:metadata:moodlenet_share_progress:courseid'] = 'O ID do curso associado';
$string['privacy:metadata:moodlenet_share_progress:resourceurl'] = 'A URL retornada do MoodleNet após um compartilhamento bem-sucedido';
$string['privacy:metadata:moodlenet_share_progress:status'] = 'O status resultante do compartilhamento';
$string['privacy:metadata:moodlenet_share_progress:timecreated'] = 'A hora em que o compartilhamento foi realizado';
$string['privacy:metadata:moodlenet_share_progress:type'] = 'O tipo de compartilhamento que foi realizado';
$string['privacy:metadata:moodlenet_share_progress:userid'] = 'O usuário que executou o compartilhamento';
...
$string['registrationemail'] = 'Avisos via E-mail';
...
$string['resendemail'] = 'Reenviar email de confirmação';
$string['reset'] = 'Reconfigurar';
$string['resetcomponent'] = 'Componente';
$string['resetcourse'] = 'Reconfigurar curso';
$string['resetcourseconfirm'] = 'Reconfigurar o curso?';
$string['resetcoursewarning'] = 'Tem certeza de que deseja reconfigurar o curso \'{$a}\'?
<br/><br/>
Isso excluirá os dados selecionados e redefinirá o curso ao seu estado original. Você não pode desfazer esta ação.';
$string['resetinfo'] = 'Este recurso permite limpar todos os dados de usuário e reconfigurar o curso para seu estado original. As atividades do curso e configurações permanecerão inalteradas.';
$string['resetinfoselect'] = 'Selecione os dados que deseja excluir ou redefinir nas categorias abaixo:';
...
$string['restoredaccountinfo'] = 'Esta conta foi importada de outro servidor e a senha foi perdida. Para definir uma nova senha por e-mail, por favor clique em "Continuar"';
$string['restorefinished'] = 'A restauração foi concluída com sucesso';
$string['restoreinfo'] = 'Usar um arquivo de backup para restaurar uma versão anterior de um curso ou para criar um novo curso.';
...
$string['rolerenaming_help'] = 'Alterar os nomes exibidos para os papéis neste curso.';
$string['rolerenaming_success'] = 'Nomes de papéis em cursos atualizados.';
$string['roles'] = 'Papéis';
$string['rss'] = 'RSS';
...
$string['rsserrorguest'] = 'Este feed utiliza o acesso de visitante para acessar os dados, porém o visitante não tem permissão para ver os dados. Visite o local original de que este feed vem (URL) como um usuário válido para obter um novo link RSS.';
...
$string['sectionoutline'] = 'Contorno da seção';
...
$string['selecttheme'] = 'Selecionar tema';
$string['selectthemename'] = 'Selecionar tema \'{$a}\'';
$string['senddetails'] = 'Enviar meus dados via e-mail';
$string['sent'] = 'Enviado';
$string['separate'] = 'Separar';
$string['separateandconnected'] = 'Formas de saber: conectada e destacada';
$string['separateandconnected1'] = 'Sobretudo saber destacado';
$string['separateandconnected2'] = 'Destacado e conectado';
$string['separateandconnected3'] = 'Sobretudo saber conectado';
...
$string['signoutofotherservices'] = 'Sair de todos os aplicativos web';
$string['signoutofotherservices_help'] = 'Sair de todos os dispositivos e sistemas que usam serviços web, como o aplicativo móvel. As sessões do navegador permanecerão ativas.';
$string['since'] = 'Desde';
...
$string['startdatewithtaskenabled'] = 'Data de início do curso';
$string['startdatewithtaskenabled_help'] = 'A data em que o curso se torna visível aos participantes. Antes dessa data, eles não poderão acessar o curso.

Essa data também determina o início da primeira semana de um curso em formato semanal e é a data inicial dos registros (logs) de atividades do curso. Se você reiniciar o curso e alterar essa data, todas as datas do curso serão alteradas com base na nova data de início.';
...
$string['statuschecks'] = 'Verificações de status';
$string['statuscritical'] = 'Crítico';
$string['statusdone'] = 'Concluído';
...
$string['subsectionmoveerror'] = 'Não é possível mover esta subseção para outra subseção';
...
$string['theme'] = 'Tema';
$string['themepreviewdescription'] = '{$a} descrição do tema';
$string['themepreviewimage'] = '{$a} visualização de imagem';
$string['themes'] = 'Temas';
...
$string['toomanybounces'] = 'Este endereço de e-mail deu origem a muitos erros de aceitação. Você tem que mudá-lo para continuar.';
...
$string['usernameemail'] = 'Identificação ou e-mail';
$string['usernameemailmatch'] = 'A identificação de usuário e o e-mail não correspondem ao mesmo usuário';
...
$string['userselectorsearchanywhere'] = 'em qualquer lugar';
$string['userselectorsearchexactmatchonly'] = 'apenas correspondências exatas';
$string['userselectorsearchfromstart'] = 'do começo';
$string['userselectorsearchmatching'] = 'Coincidindo:';
...
Se você ainda não fez, você deve editar sua página de perfil para que possamos saber mais sobre você:
