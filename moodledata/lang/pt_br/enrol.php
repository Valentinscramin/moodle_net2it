...
/**
 * Strings for component 'enrol', language 'pt_br', version '4.5'.
 *
 * @package     enrol
 * @category    string
...
$string['customwelcomemessage_help'] = 'Formatos aceitos: texto simples ou formato Moodle-auto. Tags HTML e tags multilíngues também são aceitas, assim como os seguintes espaços reservados:
<br>
* Nome do curso {$a->coursename}<br>
* Link para a página de perfil do usuário {$a->profileurl}<br>
* E-mail do usuário {$a->email}<br>
* Nome completo do usuário {$a->fullname}<br>
* Primeiro nome do usuário {$a->firstname}<br>
* Último nome do usuário {$a->lastname}<br>
* Papel do usuário no curso {$a->courserole}';
$string['customwelcomemessageplaceholder'] = 'Oi {$a->fullname}, você foi inscrito no curso {$a->coursename}';
...
$string['extremovedaction_help'] = 'Selecionar o que deve ser feito quando a inscrição do usuário desaparece de uma fonte externa de inscrições. Note que alguns dados de usuários e configurações são apagadas do curso quando a inscrição é cancelada.';
...
$string['plugindisabled'] = 'Plugin de inscrição {$a} está desativado';
...
$string['sendcoursewelcomemessage_help'] = 'Ao inscrever um usuário ou coorte no curso, eles podem receber um e-mail de mensagem de boas-vindas. Se enviado pelo contato do curso (por padrão o professor), e mais de um usuário tiver este papel, o e-mail será enviado pelo primeiro usuário associado ao papel.';
