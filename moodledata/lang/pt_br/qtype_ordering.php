...
/**
 * Strings for component 'qtype_ordering', language 'pt_br', version '4.5'.
 *
...
$string['draggableitemno'] = 'Item arrastável {no}';
$string['draggableitems'] = 'Itens arrastáveis';
$string['duplicatesnotallowed'] = 'Não é permitida a duplicação de itens arrastáveis. A string "{$a->text}" já está sendo usada em {$a->item}.';
...
$string['gradingtype_help'] = 'Escolha o tipo de cálculo da pontuação.
...
$string['highlightresponse'] = 'Destaque a resposta como correta ou incorreta';
...
$string['notenoughanswers'] = 'As questões de ordenação devem ter mais de {$a} respostas.';
$string['notenoughsubsetitems'] = 'Um subconjunto deve ter pelo menos {$a} itens.';
...
$string['numberingstyle_desc'] = 'O estilo de numeração padrão.';
$string['numberingstyle_help'] = 'Escolha o estilo de numeração para os itens arrastáveis nesta questão.';
...
$string['privacy:preference:gradingtype'] = 'Tipo de avaliação.';
$string['privacy:preference:layouttype'] = 'Tipo de layout.';
$string['privacy:preference:numberingstyle'] = 'Estilo de numeração.';
$string['privacy:preference:selectcount'] = 'Contagem seleção.';
$string['privacy:preference:selecttype'] = 'Tipo de seleção.';
$string['privacy:preference:showgrading'] = 'Mostrar avaliação.';
$string['regradeissuenumitemschanged'] = 'O número de itens arrastáveis mudou.';
