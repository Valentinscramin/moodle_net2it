...
/**
 * Strings for component 'calendar', language 'pt_br', version '4.5'.
 *
 * @package     calendar
 * @category    string
...
$string['coursecalendarlink'] = 'Calendário do Curso';
...
$string['detailedmonthviewfor'] = 'Ver mês em detalhes para:';
$string['detailedmonthviewtitle'] = 'Ver mês em detalhes: {$a}';
...
$string['newmonthannouncement'] = 'O calendário agora está definido como {$a}.';
$string['nocalendarsubscriptions'] = 'Ainda não há assinaturas de calendário. Você quer {$a}';
$string['nocalendarsubscriptionsimportexternal'] = 'Ainda não há assinaturas no calendário. <a href="{$a}">Importar um calendário externo</a>';
