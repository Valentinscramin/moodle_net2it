...
/**
 * Strings for component 'backup', language 'pt_br', version '4.5'.
 *
 * @package     backup
 * @category    string
...
$string['backupfile'] = 'Arquivo de backup';
...
$string['backupthenrestore'] = 'Backup completo. Comece a restaurar.';
...
$string['choosefilefromactivitybackup_help'] = 'Arquivos de backup para esta atividade.';
$string['choosefilefromautomatedbackup'] = 'Backups automáticos';
$string['choosefilefromautomatedbackup_help'] = 'Arquivos de backup gerados automaticamente.';
$string['choosefilefromcoursebackup'] = 'Área de backup do curso';
$string['choosefilefromcoursebackup_help'] = 'Arquivos de backup para este curso.';
$string['choosefilefromuserbackup'] = 'Área de backup de arquivos privados do usuário';
$string['choosefilefromuserbackup_help'] = 'Arquivos de backup privados para todos os cursos, com informações anônimas de usuário.';
...
$string['configgeneralxapistate'] = 'Define o padrão para incluir o estado do usuário no conteúdo, como atividades H5P em um backup.';
...
$string['configrestorexapistate'] = 'Define o padrão para restaurar o estado do usuário em conteúdo como atividades H5P.';
...
$string['copycoursedesc'] = 'Criar uma cópia deste curso em qualquer categoria de curso.';
...
$string['error_delegate_section_not_found'] = 'Faltando seção associada ao módulo do curso (ID: {$a}. A seção não será salva no backup.';
...
$string['generalxapistate'] = 'Incluir o estado do usuário no conteúdo como atividades H5P';
...
$string['importfile'] = 'Carregar um arquivo de backup';
$string['importfromccmidtocourse'] = 'Importar de cmid:{$a->srccmid} para o curso:{$a->dstcourseid}';
$string['importfromcoursetocourse'] = 'Importar do curso:{$a->srccourseid} para o curso:{$a->dstcourseid}';
...
$string['includeuserinfo_instance'] = 'Incluir dados de usuário {$a}';
...
$string['managefiles_activity'] = 'Gerenciar backups de atividades';
$string['managefiles_automated'] = 'Gerenciar backups automáticos';
$string['managefiles_backup'] = 'Gerenciar backups privados';
$string['managefiles_course'] = 'Gerenciar backups de cursos';
...
$string['morecoursesearchresults'] = 'Mais de {$a} cursos encontrados, mostrando os primeiros {$a} resultados';
...
$string['restorenofilesbackuparea'] = 'Ainda não há arquivos de backup.';
$string['restorenofilesbackuparea_activity'] = 'Ainda não há arquivos de backup para esta atividade.';
$string['restorenofilesbackuparea_automated'] = 'Ainda não há arquivos de backup automáticos.';
$string['restorenofilesbackuparea_backup'] = 'Você ainda não possui arquivos de backup privados.';
$string['restorenofilesbackuparea_course'] = 'Ainda não há arquivos de backup para este curso.';
...
$string['rootsettingxapistate'] = 'Incluir o estado do usuário no conteúdo como atividades H5P';
...
$string['subsectioncontent'] = 'Conteúdo da subseção';
