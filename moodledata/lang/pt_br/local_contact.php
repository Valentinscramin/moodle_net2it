...
/**
 * Strings for component 'local_contact', language 'pt_br', version '4.5'.
 *
...
$string['attachment'] = 'Habilitar arquivos anexos';
$string['attachment_description'] = 'Quando habilitado, o Formulário de Contato permitirá um anexo. Consulte o README.md para obter detalhes sobre como adicionar um anexo ao seu formulário.';
