...
/**
 * Strings for component 'feedback', language 'pt_br', version '4.5'.
 *
 * @package     feedback
 * @category    string
...
$string['cannotcreatepagebreak'] = 'Quebras de página não podem ser adicionadas no início de um feedback, e apenas uma quebra de página pode ser adicionada no final.';
...
$string['completionsubmit'] = 'Enviar feedback';
...
$string['feedback:receivemail'] = 'Receber um e-mail de notificação';
...
$string['indicator:socialbreadth_help'] = 'Este indicador baseia-se no engajamento social alcançada pelo estudante em uma atividade Pesquisa.';
...
* Para pesquisas anônimas: os participantes podem enviar respostas ilimitadas e todas as respostas serão registradas.
* Para pesquisas não anônimas: os participantes podem enviar respostas ilimitadas, mas apenas a resposta mais recente será registrada.';
$string['name'] = 'Nome';
...
$string['previewquestions'] = 'Ver questões';
...
$string['resetting_data'] = 'Excluir as respostas da pesquisa';
$string['resetting_delete'] = 'Excluir respostas';
...
$string['update_item'] = 'Salvar modificações da pergunta';
