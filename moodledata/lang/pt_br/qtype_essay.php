...
/**
 * Strings for component 'qtype_essay', language 'pt_br', version '4.5'.
 *
 * @package     qtype_essay
 * @category    string
...
$string['wordcounttoofew'] = 'Contagem de palavras: {$a->count} menos que as {$a->limit} palavras necessárias.';
$string['wordcounttoomuch'] = 'Contagem de palavras: {$a->count}, mais do que o limite de {$a->limit} palavras.';
