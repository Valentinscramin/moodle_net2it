...
/**
 * Strings for component 'completion', language 'pt_br', version '4.5'.
 *
 * @package     completion
 * @category    string
...
$string['all'] = 'Todos';
$string['allconditions'] = 'A atividade é concluída quando os estudantes fazem o seguinte:';
$string['any'] = 'Qualquer';
...
$string['badautocompletion'] = 'Você deve selecionar pelo menos uma condição.';
...
$string['completedunlockedtext'] = 'Quando você salvar este formuário, os dados de conclusão serão  excluídos e recalculados quando possível. Para evitar isso, não salve os dados deste formulário.';
$string['completedwarning'] = 'Opções de conclusão bloqueadas';
$string['completedwarningtext'] = 'Esta atividade está marcada como concluída para um ou mais estudantes. Se você desbloquear as configurações para fazer uma alteração e salvar o formulário, os dados de conclusão serão excluídos e recalculados sempre que possível. A conclusão manual não pode ser recalculada, então, nesse caso, o estudante precisará marcá-la como concluída novamente.';
...
$string['completion_automatic'] = 'Adicionar requisitos';
...
$string['completion_manual'] = 'Os estudantes devem marcar manualmente a atividade como concluída';
$string['completion_none'] = 'Não indicar a conclusão da atividade';
...
$string['completionexpected'] = 'Definir lembrete na linha do tempo';
$string['completionexpected_help'] = 'Isso permite que você defina um lembrete para os estudantes trabalharem nesta atividade. Ele aparecerá no bloco Timeline do painel como "{$a} requer ação".';
...
$string['completionview_desc'] = 'Ver a atividade';
...
$string['coursecompletionsettings'] = 'Configurações de conclusão do curso';
...
$string['defaultactivitycompletioncourse'] = 'Estas são as condições padrão de conclusão das atividades deste curso.';
$string['defaultactivitycompletionsite'] = 'Estas são as condições padrão de conclusão das atividades de todos os cursos.';
...
$string['emptyconditionsinfo'] = 'Não há condições de conclusão definidas para esta atividade.';
$string['emptyconditionswarning'] = 'Você deve adicionar pelo menos uma condição de conclusão.';
$string['enablecompletion'] = 'Ativar acompanhamento de conclusão';
$string['enablecompletion_help'] = 'Se ativado, você pode definir condições para a conclusão da atividade ou do curso.';
...
$string['incompatibleplugin'] = 'Esta atividade não suporta configurações de conclusão padrão. As condições de conclusão devem ser definidas manualmente para cada uso.';
...
$string['showcompletionconditions_help'] = 'Mostrar condições de conclusão da atividade na página do curso.';
$string['showinguser'] = 'Exibindo usuário';
$string['studentsmust'] = 'Os estudantes devem';
