...
/**
 * Strings for component 'tool_brickfield', language 'pt_br', version '4.5'.
 *
...
$string['analysistype_desc'] = 'Permitir que análise de conteúdo seja solicitada';
...
$string['bannercontenttwo'] = 'Construa uma plataforma de ensino e aprendizado eficaz e inclusiva encontrando conteúdo que não atenda às diretrizes, corrigindo os problemas e preparando o conteúdo do seu curso Moodle para o futuro com arquivos acessíveis, editor e recursos aprimorados.';
...
$string['checkdesc:areahasaltvalue'] = 'Áreas usadas em mapas de imagem não devem ter texto \'alt\' (alternativo) ausente, semelhante a imagens.';
...
$string['checkdesc:objectmusthavetitle'] = 'Elementos de objeto (para incorporar recursos externos) não devem ter suas descrições \'title\' ausentes.';
...
$string['checkdesc:strikeisnotused'] = 'Elementos de riscado (sobrelinhado) não devem ser usados; \'del\' (excluído) deve ser usado em vez disso.';
...
$string['checkidvalidation'] = 'Tarefa para verificar quaisquer IDs de verificação inválidos';
...
$string['cmpercenttitle'] = 'Percentual geral de atividades versus erros';
...
$string['contenttwo'] = 'Atualização em massa de texto obscuro ou ausente para links da web, descrições de imagem e legendas de vídeo.';
...
$string['icon:analytics-custom'] = 'Ícone de análise';
$string['icon:file-edit-custom'] = 'Ícone de edição de arquivo';
$string['icon:hands-helping-custom'] = 'Ícone de mãos ajudando';
...
$string['pagedesc:pertarget'] = '<p>Para resumir e analisar os resultados da verificação por atividade, agrupamos esses resultados de verificação nas diferentes atividades detectadas.</p><p>As atividades são incluídas como atividades, recursos ou outras áreas de conteúdo relacionadas aos próprios cursos. Cada atividade sem erros detectados é contada como aprovada, cada atividade com um ou mais erros detectados é contada como reprovada. A proporção de atividades aprovadas para reprovadas é então exibida.</p>
<p>A página do gráfico de detalhamento da atividade exibe a proporção de instâncias aprovadas para reprovadas no total, por atividade, como tarefa, curso, rótulo, etc.</p>';
...
$string['secretkey_help'] = 'Este código é o recebido por e-mail após o registro.';
...
$string['sitehash_help'] = 'Este código é recebido por e-mail após o registro.';
...
$string['targetratio'] = 'Taxa de aprovação da atividade';
...
$string['tbloverallpercentage'] = 'Percentual geral de erros';
$string['tblpercentage'] = 'Porcentagem';
$string['tblpreview'] = 'Prévia';
