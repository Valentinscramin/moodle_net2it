...
/**
 * Strings for component 'report_security', language 'pt_br', version '4.5'.
 *
...
$string['check_antivirus_details'] = 'Este status verifica se houve ou não um erro recente detectado com base no limite definido nas configurações principais do antivírus.';
...
$string['check_defaultuserrole_details'] = '<p>Todos os usuários autenticados recebem as permissões do papel padrão. Por favor, certifique-se que nenhuma ação arriscada é permitida para este papel.</p>
<p>O único tipo legado suportado para o papel de usuário padrão é <em>Usuário autenticado</em>. A permissão de visualização do curso não deve estar habilitada.</p>
<p>Verifique se a opção de aprovação automática de solicitação de exclusão de dados (tool_dataprivacy | automaticdatadeletionapproval) está habilitada. Os usuários podem solicitar exclusões que podem excluir grandes quantidades de dados.</p>';
...
$string['check_emailchangeconfirmation_details'] = '<p>É recomendado que seja exigido um passo de confirmação de e-mail quando os usuários trocam seus e-mails no perfil. Se desabilitado, spammers podem tentar utilizar o servidor para enviar spam.</p><p>O campo de e-mail também deve ser trancado para os plugins de autenticação, mas esta possibilidade não é considerada aqui.</p>';
$string['check_emailchangeconfirmation_error'] = 'Usuários podem inserir qualquer endereço de e-mail.';
$string['check_emailchangeconfirmation_info'] = 'Usuários devem inserir endereços de e-mail apenas dos domínios autorizados.';
$string['check_emailchangeconfirmation_name'] = 'Confirmação de alteração de e-mail';
$string['check_emailchangeconfirmation_ok'] = 'Confirmação da alteração do endereço de e-mail no perfil de usuário.';
...
$string['check_openprofiles_error'] = 'Qualquer um pode ver perfis de usuários sem autenticar-se.';
$string['check_openprofiles_name'] = 'Perfis abertos de usuários';
$string['check_openprofiles_ok'] = 'É exigido login para ver perfis de usuários.';
...
$string['check_upgradefile_info'] = 'Arquivos de notas de atualização não devem ser públicos';
