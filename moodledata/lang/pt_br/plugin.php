...
/**
 * Strings for component 'plugin', language 'pt_br', version '4.5'.
 *
 * @package     plugin
 * @category    string
...
$string['cancelinstallinfo'] = 'Os seguintes plugins ainda não foram totalmente instalados, portanto sua instalação pode ser cancelada. Para fazer isso, a pasta do plugin deve ser removida do servidor agora. Certifique-se de que é realmente isso que você deseja fazer, para evitar a perda acidental de dados (como suas próprias modificações no código).';
...
$string['err_response_format_version'] = 'Versão inesperada do formato de resposta. Por favor, tente verificar novamente se há atualizações disponíveis.';
...
$string['filtermissingonly'] = 'Mostrar apenas ausentes no disco';
$string['filternewpluginsonly'] = 'Mostrar apenas plugins a serem instalados';
...
$string['misdepsavail'] = 'Dependências ausentes disponíveis';
...
$string['status_delete'] = 'Para ser excluído';
$string['status_downgrade'] = 'Versão superior já instalada!';
$string['status_missing'] = 'Faltando no disco!';
$string['status_new'] = 'A ser instalado';
$string['status_nodb'] = 'Sem banco de dados';
$string['status_upgrade'] = 'Para ser atualizado';
...
$string['type_aiplacement'] = 'Plugin de instalação de IA';
$string['type_aiplacement_plural'] = 'Plugins de instalação de IA';
$string['type_aiprovider'] = 'Plugin de provedor de IA';
$string['type_aiprovider_plural'] = 'Plugins de provedor de IA';
...
$string['type_cachelock_plural'] = 'Manipuladores de bloqueio de cache';
...
$string['type_communication'] = 'Provedor de comunicação';
$string['type_communication_plural'] = 'Provedores de comunicação';
...
$string['validationmsg_missingcomponent_link'] = 'Desenvolvimento: version.php';
