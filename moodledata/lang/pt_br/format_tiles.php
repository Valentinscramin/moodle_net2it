...
/**
 * Strings for component 'format_tiles', language 'pt_br', version '4.5'.
 *
...
$string['cachedef_modalcmids'] = 'IDs de módulos de curso (por curso) que precisam ser lançados com um modal';
...
$string['clearphoto'] = 'Redefinir este bloco';
$string['clickiffailstoload'] = 'Clique se a página não carregar';
$string['close'] = 'Fechar';
$string['closetopsection'] = 'Fechar seção superior';
...
$string['coursephotomigrationincomplete'] = 'Ícones e fotos dos blocos ainda não foram migrados após uma atualização do sistema. Itens ausentes devem aparecer em poucas horas após a atualização.';
...
$string['displayfilterbar_link'] = 'Resultados';
...
$string['enablelinebreakfilter_desc'] = 'Filtrar títulos de azulejos para o caractere de junção de palavras invisíveis {$a} e, se presente e o título for longo, substituí-lo por "- " para permitir quebra de linha. Caso contrário, substitua por nada (ou seja, sem quebra de linha).';
...
$string['expandtopsection'] = 'Expandir seção superior';
$string['experimental'] = 'experimental';
$string['experimentalfeatures'] = 'Recursos experimentais';
...
$string['imagesavedfor'] = 'Imagem salva para {$a}';
...
$string['jsreactivated'] = 'Você ativou a navegação animada em sua conta.';
...
$string['migratecoursedata'] = 'Migrar dados do curso';
$string['migratedcourseid'] = 'ID do curso migrado {$a}';
...
$string['newtiledata'] = 'Nova contagem de dados de blocos';
...
$string['plugin_description'] = 'Um formato visualmente rico, onde seções e atividades são representadas por blocos, com fotos, ícones e cores personalizáveis.';
...
$string['resetalltiles'] = 'Redefinir fotos e ícones dos blocos';
$string['resetalltilessure'] = 'Tem certeza de que deseja redefinir os blocos deste curso? Isso excluirá todas as fotos dos blocos e redefinirá todos os ícones para o padrão. O conteúdo não será excluído. Esta é uma ação destrutiva e não pode ser desfeita. Faça backup do seu curso primeiro, se não tiver certeza.';
...
$string['resetincomplete'] = 'Redefinição incompleta';
...
$string['setbackgroundphoto'] = 'Definir foto / ícone';
...
$string['style'] = 'Estilo';
$string['subtileiconcolourbackground'] = 'Ícones de sub-bloco - usar círculo de fundo colorido sólido';
$string['subtileiconcolourbackground_desc'] = 'Se marcado, os ícones de sub-bloco são exibidos como ícones brancos em um círculo de fundo colorido sólido. Caso contrário, os ícones são (1) coloridos e (2) em um círculo colorido, mas não sólido.';
$string['subtileszeczerotoggled'] = 'Seção de topo alterna entre o formato de lista e o formato de sub-blocos';
$string['suremigratelegacyoptions'] = 'Tem certeza de que deseja migrar {$a} escolhas de fotos ou ícones de blocos para este curso?';
...
$string['tilearialabel'] = '{$a}, abre detalhes em um pop-up, link';
...
$string['tileicon'] = 'Ícone / foto para exibir apenas neste bloco';
...
$string['tileselecttip'] = 'No curso, com o modo de edição ativado, basta clicar no ícone ou na foto que você deseja alterar. A janela do seletor de ícones será exibida.';
$string['tilesformatregistration'] = 'Registro do formato Blocos';
$string['tilesreset'] = 'Blocos e ícones foram redefinidos para este curso';
$string['tilestyle'] = 'Estilo de Bloco';
$string['tilestyle_desc'] = 'Estilo 1 = os blocos com foto mostrarão o título na parte superior do bloco, estilo 2 = título na parte inferior';
...
$string['unmigratedcoursesintro'] = 'Os seguintes {$a} cursos parecem não ter tido todos os seus ícones e fotos de blocos migrados após uma atualização do sistema. Clique no botão para processar um curso agora. Se você esperar, o processo em segundo plano \'cron\' deve processar todos esses, mas se desejar processar um curso específico agora, clique no botão.';
$string['uploadnewphoto'] = 'Carregar nova imagem';
$string['uploadnewphoto_help'] = 'Carregar uma imagem para ser usada neste bloco';
$string['usecourseindex'] = 'Usar índice do curso';
$string['usecourseindex_desc'] = 'Quando em um curso com blocos, o índice do curso deve ser exibido à esquerda?';
