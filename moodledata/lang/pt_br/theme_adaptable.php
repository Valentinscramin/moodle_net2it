...
/**
 * Strings for component 'theme_adaptable', language 'pt_br', version '4.5'.
 *
...
$string['alerticoninfodesc'] = 'Defina os \'<a href="{$a}" target="_blank">Ícones do Font Awesome</a>\' para serem usados em alertas do tipo info. Digite o nome do ícone sem o prefixo \'fa-\'.';
$string['alerticonsuccess'] = 'Ícone de Anúncio';
$string['alerticonsuccessdesc'] = 'Defina os \'<a href="{$a}" target="_blank">Ícones do Font Awesome</a>\' para serem usados em alertas do tipo anúncio. Insira o nome do ícone sem o prefixo \'fa-\'.';
$string['alerticonwarning'] = 'Ícone de Aviso';
$string['alerticonwarningdesc'] = 'Defina os \'<a href="{$a}" target="_blank">Ícones do Font Awesome</a>\'para serem usados em alertas do tipo aviso. Insira o nome do ícone sem o prefixo \'fa-\'.';
...
$string['categoryheaderheaderdescchildren'] = 'Define as configurações para a categoria de nível superior \'{$a->name}\' com o ID \'{$a->id}\' e suas subcategorias \'{$a->children}\'.';
...
$string['enablefeeddesc'] = 'Exibir um link para os usuários da página "Meu feeedback"- Observação: isso requer instalação adicional: <a href="{$a}" target="blank">Plugin Meu Feedback</a>';
...
$string['socialiconlistdesc'] = 'Digite uma lista delimitada para configurar os ícones / links sociais que você precisa. Isso deve estar no formato:

url|título|ícone

Por exemplo:
<pre>
https://example.com/course/search.php|Pesquisar Moodle|search
...
https://example.com|Meu Site|globe
</pre>
Onde o ícone do Font Awesome pode ser seu nome ou classes CSS. Para referência, você pode encontrar a lista completa de ícones do Font Awesome "<a href="{$a}" target="_blank">aqui</a>".';
