...
/**
 * Strings for component 'auth', language 'pt_br', version '4.5'.
 *
 * @package     auth
 * @category    string
...
$string['allowaccountssameemail_desc'] = 'Se habilitado, mais do que uma conta de usuário podem compartilhar o mesmo endereço de e-mail. Isso pode resultar em problemas de segurança ou privacidade, por exemplo, com o e-mail de confirmação de alteração de senha .';
...
$string['auth_changingemailaddress'] = 'Você pediu a mudança do e-mail de {$a->oldemail} para {$a->newemail}. Por motivos de segurança, estamos enviando a você uma mensagem no novo endereço de e-mail para confirmar que ele pertence a você. Seu endereço de e-mail será atualizado assim que você abrir o URL enviado nessa mensagem.';
...
$string['auth_fieldlocks_help'] = '<p>Você pode bloquear campos de dados de usuários. Isto é útil em sites mantidos pelo administrador manualmente, editando os registros dos usuários ou usando a função \'Upload de usuários\'. Se você bloquear campos exigidos pelo Moodle, forneça estes dados quando criar as contas de usuários ou as contas não serão utilizáveis.</p><p>Considere a possibilidade de configurar o bloqueio como \'Desbloqueado se vazio\' para evitar este problema.</p>';
$string['auth_fieldmapping'] = 'Mapeamento de dados ({$a})';
$string['auth_invalidnewemailkey'] = 'Erro: se você está tentando confirmar uma mudança de e-mail, provavelmente copiou o URL incompleto. Por favor, copie o endereço e tente novamente.';
$string['auth_loginpasswordtoggle'] = 'Alternar visibilidade da senha';
$string['auth_loginpasswordtoggle_desc'] = 'Adicionar um ícone no campo de senha da tela de login que permite aos usuários mostrar ou ocultar a senha inserida.';
$string['auth_loginrecaptcha'] = 'Habilite reCAPTCHA para login';
$string['auth_loginrecaptcha_desc'] = 'Adicione um elemento de formulário de confirmação visual/áudio à página de login. Isso reduz o risco de tentativas de login injustificadas. Consulte <a target="_blank" href="https://www.google.com/recaptcha">Google reCAPTCHA</a> para obter mais detalhes.';
...
$string['auth_outofnewemailupdateattempts'] = 'Você superou o número máximo de tentativas para atualizar seu endereço de e-mail. O seu pedido de atualização foi cancelado.';
...
$string['auth_user_creation'] = 'Novos usuários (anônimos) podem criar contas de usuários no código de origem externa confirmados via E-mail. Se você ativar esta permissão lembre-se de configurar também as opções específicas dos módulos para a criação de usuários.';
...
$string['emailchangecancel'] = 'Excluir mudança no e-mail';
$string['emailchangepending'] = 'Atualização pendente. Seguir as indicações do e-mail enviado a {$a->preference_newemail}.';
$string['emailnowexists'] = 'O endereço e-mail escolhido já foi utilizado por um outro usuário. Use um outro endereço.';
$string['emailupdate'] = 'Mudança de endereço e-mail';
...
{$a->supportemail}';
$string['emailupdatesuccess'] = 'Endereço de e-mail do usuário <em>{$a->fullname}</em> substituito por <em>{$a->email}</em>.';
$string['emailupdatetitle'] = 'Confirmação de atualização de endereço e-mail em {$a->site}';
...
$string['errorminpasswordnonalphanum'] = 'A senha deve ter pelo menos {$a} caractere(s) não-alfanumérico(s), como *, -, ou #.';
...
$string['informminpasswordnonalphanum'] = 'pelo menos {$a} caractere(s) não alfa-numéricos, como *, -, ou #.';
...
$string['showloginform'] = 'Exibir formulário de login padrão';
$string['showloginform_desc'] = 'Se o seu site usa métodos de autenticação que não exigem que os usuários insiram e-mail/nome de usuário e senha, como OAuth2, você pode ocultar o formulário de login padrão. Isso não é compatível com contas manuais.

Se você não conseguir fazer login e quiser mostrar o formulário de login, você pode alterar esta configuração com a linha de comando: php admin/cli/cfg.php --name=showloginform --set=1';
