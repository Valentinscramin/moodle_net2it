...
/**
 * Strings for component 'role', language 'pt_br', version '4.5'.
 *
 * @package     role
 * @category    string
...
$string['ai:acceptpolicy'] = 'Definir a aceitação da política de IA dos usuários';
$string['ai:fetchanyuserpolicystatus'] = 'Obter a aceitação da política de IA dos usuários';
$string['ai:fetchpolicy'] = 'Obter a aceitação da política de IA dos usuários';
...
$string['blog:view'] = 'Ver textos do blog';
$string['blog:viewdrafts'] = 'Ver entradas em rascunho no blog';
...
$string['cohort:configurecustomfields'] = 'Configurar campos personalizados de coorte';
$string['cohort:manage'] = 'Criar, excluir e mover coortes';
$string['cohort:view'] = 'Ver coortes do site';
...
$string['competency:coursecompetencyview'] = 'Ver competências do curso';
...
$string['competency:planview'] = 'Ver todos os planos de aprendizagem';
$string['competency:planviewdraft'] = 'Ver rascunhos de planos de aprendizagem';
$string['competency:planviewown'] = 'Ver os próprios planos de aprendizagem';
$string['competency:planviewowndraft'] = 'Ver os próprios rascunhos de planos de aprendizagem';
$string['competency:templatemanage'] = 'Gerenciar modelos de plano de aprendizado';
$string['competency:templateview'] = 'Ver modelos de plano de aprendizagem';
...
$string['competency:usercompetencyview'] = 'Ver uma competência do usuário';
...
$string['confirmaddadmins'] = 'Tem certeza de que deseja adicionar os seguintes usuários à lista de administradores do site?';
$string['confirmdeladmin'] = 'Você realmente deseja remover o usuário <strong>{$a}</strong> da lista de administradores do site?';
$string['confirmremoveadmins'] = 'Tem certeza de que deseja remover os seguintes usuários da lista de administradores do site?';
...
$string['contentbank:changelockedcustomfields'] = 'Alterar campos personalizados bloqueados para o banco de conteúdo';
$string['contentbank:configurecustomfields'] = 'Configurar campos personalizados para o banco de conteúdo';
$string['contentbank:copyanycontent'] = 'Copiar qualquer conteúdo do banco de conteúdo';
$string['contentbank:copycontent'] = 'Copiar o conteúdo no banco de conteúdo';
...
$string['contentbank:viewunlistedcontent'] = 'Ver o conteúdo não listado do banco de conteúdo';
...
$string['course:configurecoursecommunication'] = 'Definir configurações de comunicação do curso';
$string['course:configurecustomfields'] = 'Configurar campos personalizados de curso';
...
$string['course:editcoursewelcomemessage'] = 'Editar mensagem de boas-vindas do curso';
...
$string['course:view'] = 'Ver cursos sem participação';
$string['course:viewcoursegrades'] = 'Ver notas do curso';
$string['course:viewhiddenactivities'] = 'Ver atividades ocultas';
$string['course:viewhiddencourses'] = 'Ver cursos que estão ocultos';
$string['course:viewhiddengroups'] = 'Ver grupos ocultos';
$string['course:viewhiddensections'] = 'Ver seções ocultas';
$string['course:viewhiddenuserfields'] = 'Ver campos ocultos do usuário';
$string['course:viewparticipants'] = 'Ver participantes';
$string['course:viewscales'] = 'Ver escalas de avaliação';
$string['course:viewsuspendedusers'] = 'Ver usuários suspensos';
...
$string['h5p:updatelibraries'] = 'Gerenciar os tipos de de conteúdo H5P';
...
$string['moodlenet:shareactivity'] = 'Compartilhar atividades no MoodleNet';
$string['moodlenet:sharecourse'] = 'Compartilhar o curso no MoodleNet';
...
$string['roleassignment'] = 'Atribuição de papéis';
...
$string['site:viewfullnames'] = 'Sempre Ver o nome completo do usuário';
...
$string['user:readuserposts'] = 'Ver todos as postagens do usuário nos fóruns';
$string['user:update'] = 'Atualizar perfil de usuário';
$string['user:viewalldetails'] = 'Ver informação completa do usuário';
$string['user:viewdetails'] = 'Ver perfil de usuário';
$string['user:viewhiddendetails'] = 'Ver detalhes ocultos dos usuários';
$string['user:viewlastip'] = 'Ver último endereço IP do usuário';
$string['user:viewprofilepictures'] = 'Ver fotos do perfil do usuário (se o login forçado estiver habilitado)';
$string['user:viewuseractivitiesreport'] = 'Ver relatório de atividade oculta';
$string['user:viewusergrades'] = 'Ver notas do usuário';
...
$string['viewrole'] = 'Ver detalhes dos papéis';
