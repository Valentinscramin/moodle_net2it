...
/**
 * Strings for component 'factor_totp', language 'pt_br', version '4.5'.
 *
 * @package     factor_totp
 * @category    string
...
$string['settings:window_help'] = 'A janela do TOTP atua como desvio de tempo e especifica por quanto tempo cada código é válido.
O período, que é o tempo entre os códigos recém-gerados, é de 30 segundos.
Se a janela for 15 (o padrão) e o timestamp de data/hora atual for 147682209, o OTP testado estará entre 147682194 (147682209 - 15), 147682209 e 147682224 (147682209 + 15).
A janela deve ser menor que 30. Portanto, este teste inclui o OTP anterior, mas não o próximo.
Você pode definir isso para um valor mais alto (até 29) como uma solução alternativa se os relógios do dispositivo do seu usuário estiverem frequentemente um pouco errados.';
