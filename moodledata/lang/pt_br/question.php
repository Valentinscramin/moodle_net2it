...
/**
 * Strings for component 'question', language 'pt_br', version '4.5'.
 *
 * @package     question
 * @category    string
...
$string['cannotfindquestionfile'] = 'Não foi possível encontrar o arquivo de questões no zip';
$string['cannotgetdsfordependent'] = 'Não foi possível obter o conjunto de dados especificado para uma questão dependente de conjunto de dados! (questão: {$a->id}, datasetitem: {$a->item})';
$string['cannotgetdsforquestion'] = 'Não foi possível obter o conjunto de dados para uma questão calculada! (questão: {$a})';
$string['cannothidequestion'] = 'Não foi possível ocultar a questão';
...
$string['cannotinsertquestioncatecontext'] = 'Não foi possível inserir a nova categoría de questões {$a->cat} contextid ilegal {$a->ctx}';
...
$string['cannotpreview'] = 'Você não pode ver a prévia destas questões!';
...
$string['cannotretrieveqcat'] = 'Não foi possível recuperar a categoria de questão';
$string['cannotunhidequestion'] = 'Falha ao exibir a questão.';
...
$string['deletequestioncheck'] = 'Isso excluirá a seguinte questão e todas as suas versões:<br /><br />{$a}';
$string['deletequestionscheck'] = 'Isso excluirá as seguintes questões e todas as suas versões:<br /><br />{$a}';
$string['deletequestiontitle'] = 'Excluir questão?';
$string['deletequestiontitle_plural'] = 'Excluir questões?';
$string['deleteselectedquestioncheck'] = 'Isso excluirá versões selecionadas da seguinte questão:<br /><br />{$a}';
$string['deleteversiontitle'] = 'Excluir a versão selecionada?';
$string['deleteversiontitle_plural'] = 'Excluir as versões selecionadas?';
...
$string['eventqbankdisabled'] = 'Plugin Banco de questões desativado';
$string['eventqbankenabled'] = 'Plugin Banco de questões ativado';
...
$string['flagthisquestion'] = 'Marcar esta questão';
...
$string['idnumber_help'] = 'Se usado, o ID number deve ser exclusivo dentro de cada categoria de questão. Ele fornece outra maneira de identificar uma questão que às vezes é útil, mas geralmente pode ser deixada em branco.';
...
$string['importquestions_help'] = 'Esta função possibilita a importação de questões em distintos formatos por meio de um arquivo de texto. Observe que o arquivo deve ter a codificação UTF-8.';
...
$string['invalidgrade'] = 'Avaliações ({$a}) não correspondem às opções de avaliação - questão ignorada.';
$string['invalidgradequestion'] = 'As notas ({$a->grades}) não correspondem às opções de notas - questão \'{$a->question}\' ignorada.';
...
$string['matchgrades_help'] = '<p>As notas importadas <b>devem</b> coincidir com uma das notas válidas da lista predeterminada, como:</p>
<ul>
  <li>100%</li>
  <li>90%</li>
  <li>80%</li>
...
<p>Valores negativos da lista também são permitidos.</p>
<p>Há duas configurações para esta chave. Elas afetam como a rotina de importação trata os valores que não coincidem <strong>exatamente</strong> com um dos valores da lista acima.</p>
<ul>
  <li><strong>Erro se a nota não está na lista</strong><br />Se a questão  contem qualquer nota não encontrada na lista um erro é mostrado e a questão não será importada.</li>
  <li><strong>Nota mais próxima se não está na lista</strong><br />Se a nota não coincide com um valor da lista, a nota é alterada para o valor mais próximo da lista.</li>
</ul>';
...
$string['noconditionspecified'] = 'Por favor, especifique uma condição';
...
$string['penaltyfactor_help'] = 'Esta configuração define qual a fração da nota obtida deverá ser subtraída para cada resposta errada. Isto somente é relevante se o questionário estiver rodando no modo adaptativo onde o estudante pode responder várias vezes a mesma questão.

O fator de penalidade deve ser um número entre 0 e 1. Um fator de penalidade de 1 significa que o estudante tem que conseguir a resposta correta na primeira resposta para obter qualquer crédito por isso no total. Um fator de penalidade de 0 significa que o estudante pode tentar tantas vezes quantas desejar e ainda obter as notas totais.</p>';
...
$string['previewquestion'] = 'Ver prévia da questão: {$a}';
...
$string['privacy:metadata:database:question_attempt_steps'] = 'Cada tentativa da questão tem várias etapas para indicar as diferentes fases, desde o início até a conclusão até a avaliação. Esta tabela armazena as informações para cada uma dessas etapas.';
...
$string['privacy:metadata:database:question_attempt_steps:state'] = 'O estado desta tentativa de questão ao final da transição da etapa.';
...
$string['privacy:metadata:link:qbehaviour'] = 'O subsistema Questão faz uso do tipo de plugin Comportamento da Questão.';
$string['privacy:metadata:link:qformat'] = 'O subsistema Questão utiliza o plugin tipo Formato da Questão para fins de importação e exportação de questões em diversos formatos.';
$string['privacy:metadata:link:qtype'] = 'O subsistema Questão interage com o tipo de plugin Tipo de Questão que contém os diferentes tipos de questões.';
...
$string['questionbanknavigation'] = 'Navegação terciária do banco de questões';
...
$string['questiondefaultssave'] = 'Habilitar salvamento de padrões de questão';
$string['questiondefaultssave_desc'] = 'Quando habilitado, os valores de determinados elementos do formulário de questão serão salvos como preferências do usuário quando o formulário for enviado. O valor armazenado na preferência do usuário será usado como valor padrão na próxima vez que o formulário for visualizado.';
$string['questiondoesnotexist'] = 'Esta questão não existe';
$string['questionediting'] = 'Edição de questões';
$string['questionediting_desc'] = 'Essas configurações controlam os recursos dos formulários de edição de questões';
...
$string['questionsinuse'] = '* Indica questões que não podem ser excluídas porque estão em uso. Em vez disso, elas ficarão ocultas no banco de questões, a menos que você selecione ‘Mostrar questões antigas’.';
...
$string['restartwiththeseoptions'] = 'Salvar opções de visualização e começar novamente';
...
$string['saveflags'] = 'Salvar o estado das marcas';
...
$string['selectquestionsforbulk'] = 'Selecionar Questões para ações em lote';
...
$string['shortversioninfolatest'] = 'v{$a->version} (mais recente)';
$string['showhidden'] = 'Mostrar questões ocultas';
...
$string['stoponerror_help'] = 'Esta opção determina se o processo de importação deve parar quando um erro é detectado, resultando em nenhuma questão importada, ou se quaisquer questões que contenham erros sejam ignoradas e somente questões válidas sejam importadas.';
...
$string['technicalinfovariant'] = 'Questão variável: {$a}';
...
$string['versioninfolatest'] = 'Versão {$a->version} (mais recente)';
