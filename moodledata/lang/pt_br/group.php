...
/**
 * Strings for component 'group', language 'pt_br', version '4.5'.
 *
 * @package     group
 * @category    string
...
$string['deleteselectedgroup'] = 'Excluir';
$string['disablemessagingaction'] = 'Desabilitar mensagens';
...
$string['enablemessagingaction'] = 'Habilitar mensagem';
...
$string['erroraddtogroup'] = 'Valor inválido para Adicionar ao grupo. Deve ser 0 para nenhum modo de grupo ou 1 para um novo grupo a ser criado.';
$string['erroraddtogroupgroupname'] = 'Você não pode especificar nome do grupo quando Adicionar ao grupo estiver definido.';
...
$string['groupmode_groupsseparate_help'] = 'Os estudantes são divididos em grupos e só podem ver o trabalho do seu grupo.';
$string['groupmode_groupsvisible_help'] = 'Os estudantes são divididos em grupos, mas podem ver o trabalho de outros grupos.';
$string['groupmode_help'] = '* Nenhum grupo
* Grupos separados: Os estudantes são divididos em grupos e só podem ver o trabalho do seu grupo.
* Grupos visíveis: Os estudantes são divididos em grupos, mas podem ver o trabalho de outros grupos.

O modo de grupo definido no nível do curso é o modo padrão para todas as atividades. Se o modo de grupo for forçado no nível do curso, não poderá ser alterado em uma atividade.';
$string['groupmodeforce'] = 'Forçar modalidade grupo';
$string['groupmodeforce_help'] = 'O modo de grupo é aplicado a todas as atividades e não pode ser alterado em uma atividade.';
...
$string['includeonlyactiveenrol'] = 'Incluir somente inscrições ativas';
...
$string['manageactions'] = 'Gerenciar';
$string['memberofgroup'] = 'Membro do grupo: {$a}';
$string['members'] = 'Membros por grupo';
$string['membersofselectedgroup'] = 'Membros de:';
$string['messagingdisabled'] = 'Mensagens desabilitadas com sucesso em {$a} grupo(s)';
$string['messagingenabled'] = 'Mensagens habilitadas com sucesso em {$a} grupo(s)';
...
$string['participation_help'] = 'Os membros do grupo devem poder selecionar este grupo para atividades no modo de grupos separados ou visíveis? (Somente aplicável se a associação ao grupo for visível ou apenas visível para os membros.)';
...
$string['removegroupingsmembers'] = 'Excluir todos os grupos de agrupamentos';
$string['removegroupsmembers'] = 'Excluir todos os membros do grupo';
...
$string['visibility_help'] = '* Visível - todos os participantes do curso podem ver quem está no grupo
* Apenas visível para os membros - participantes do curso que não estão no grupo não podem ver o grupo ou seus membros
* Ver apenas a própria associação - um usuário pode ver que está no grupo, mas não pode ver outros membros do grupo
* Oculto - apenas os professores podem ver o grupo e seus membros

Usuários com permissão de ver grupos ocultos sempre podem ver a associação ao grupo.

Observação: você não pode alterar essa configuração se o grupo tiver membros.';
