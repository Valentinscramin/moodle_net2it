...
/**
 * Strings for component 'tool_certification', language 'pt_br', version '4.5'.
 *
...
$string['allocatetocertification'] = 'Alocar para certificação';
...
$string['becamecertified'] = 'Tornou-se certificado ({$a})';
...
$string['certificationnamewitheditlink'] = 'Nome da certificação com link para editar';
$string['certificationprogress'] = 'Progresso da certificação';
$string['certificationprogressexport'] = '{$a} progresso da certificação';
...
$string['certificationtenant'] = 'Tenant da certificação';
...
$string['certifieddateisonorafter'] = 'A data de certificação é igual ou posterior';
...
$string['conditioncertificationcertifieddescription'] = 'Usuários certificados na certificação \'{$a->fullname}\'';
$string['conditioncertificationcertifieddescriptionallwithdate'] = 'Usuários certificados em todas as seguintes certificações: \'{$a->fullname}\'<br />
A data de certificação é igual ou posterior a \'{$a->conditiondate}\'';
$string['conditioncertificationcertifieddescriptionany'] = 'Usuários certificados em pelo menos uma das seguintes certificações: \'{$a->fullname}\'';
$string['conditioncertificationcertifieddescriptionanywithdate'] = 'Usuários certificados em pelo menos uma das seguintes certificações: \'{$a->fullname}\'<br />
A data de certificação é igual ou posterior a \'{$a->conditiondate}\'';
...
$string['conditioncertificationcertifieddescriptionwithdate'] = 'Usuários certificados na certificação \'{$a->fullname}\'<br />
A data de certificação é igual ou posterior a \'{$a->conditiondate}\'';
...
$string['conditioncertificationexpireddescription'] = 'Usuários cuja certificação \'{$a}\' expirou';
$string['conditioncertificationexpireddescriptionwithdate'] = 'Usuários cuja certificação \'{$a->fullname}\' expirou <br />
A data de expiração é igual ou posterior a \'{$a->conditiondate}\'';
$string['conditioncertificationnotcertified'] = 'Certificação não certificada';
$string['conditioncertificationnotcertifieddescription'] = 'Usuários que não são certificados na certificação \'{$a}\'';
$string['conditioncertificationoverdue'] = 'Certificação atrasada';
$string['conditioncertificationoverduedescription'] = 'Usuários com certificação atrasada \'{$a}\'';
$string['conditioncertificationoverduedescriptionwithdate'] = 'Usuários com atraso na certificação \'{$a->fullname}\'<br />
A data de vencimento é igual ou posterior a \'{$a->conditiondate}\'';
$string['conditioncertificationsuspended'] = 'Certificação suspensa';
$string['conditioncertificationsuspendeddescription'] = 'Usuários suspensos na certificação \'{$a}\'';
$string['conditioncertificationsuspendeddescriptionwithdate'] = 'Usuários suspensos na certificação \'{$a->fullname}\'<br />
A data de suspensão é em ou após \'{$a->conditiondate}\'';
...
$string['currentprogramprogress'] = 'Progresso atual do programa';
$string['currentprogramstatus'] = 'Status atual do programa';
...
$string['displaycertificationduedate'] = 'Data de vencimento da certificação';
...
$string['displaycertificationreopen'] = 'Data de início da recertificação';
...
$string['displayrecertificationprogramname'] = 'Nome do programa de recertificação';
$string['dontchange'] = 'Não mudar';
...
$string['editstatusanddates'] = 'Editar o status e as datas';
...
$string['expiredcertificationslink'] = '<a href="{$a->href}">{$a->count} certificações expiradas</a>';
...
$string['fullcertificationreport'] = 'Relatório completo de certificação';
...
$string['notificationcertificationuserallocated'] = 'Olá, {$a->userfullname},<br /><br />
Bem-vindo ao programa \'{$a->programname}\', que você pode encontrar na página \'Meus cursos\'.<br /><br />
{$a->certmsg}<br /><br />
{$a->sitename}<br />
{$a->siteurl}';
...
$string['outcomeallocationdesckeepdate'] = 'Cancelar a suspensão e deixar a data de início da certificação existente';
$string['outcomeallocationdesckeepstartdate'] = 'Manter a data de início padrão da certificação';
$string['outcomeallocationdescription'] = 'Alocar usuários a certificações {$a}<br />
Manter a data de início padrão da certificação';
$string['outcomeallocationdontmodify'] = 'Não modificar as alocações';
...
$string['userlist'] = 'Seleciona os usuários';
$string['userlist_help'] = 'Selecionar os usuários para alocar a esta certificação';
