...
/**
 * Strings for component 'quiz', language 'pt_br', version '4.5'.
 *
 * @package     quiz
 * @category    string
...
$string['accessnoticesheader'] = 'Você pode ver este teste, mas se isto fosse uma tentativa real, você seria bloqueado porque:';
$string['action'] = 'Ação';
...
$string['addarandomquestion_success'] = 'Questões aleatórias foram adicionadas';
$string['addarandomselectedquestion'] = 'Adicionar uma questão aleatória...';
$string['addasection'] = 'um novo título de seção';
...
$string['attemptduration'] = 'Duração';
...
$string['attemptgradeddelay_desc'] = 'Um atraso é aplicado antes de enviar notificações de tentativa avaliada para dar tempo ao professor de editar a nota.';
...
$string['cannotremoveallsectionslots'] = 'Você selecionou todas as questões no título da seção "{$a}". Não é permitido remover todas as questões do título da seção.';
...
$string['canredoquestions_desc'] = 'Se habilitado, quando os estudantes terminarem a tentativa de uma questão específica, eles verão um botão\'Tentar outra questão como esta\'. Isso permite que eles tentem uma questão semelhante (selecionada aleatoriamente), sem ter que enviar toda a tentativa do questionário e começar outra tentativa. Essa opção é útil principalmente para testes de prática.

Esta configuração afeta somente questões (por exemplo questões não dissertativas) e comportamentos (por exemplo, feedback imediato, ou interativo com várias tentativas), onde é possível ao estudante finalizar a questão antes da tentativa ser enviada.';
$string['canredoquestions_help'] = 'Se habilitado, quando os estudantes terminarem a tentativa de uma questão específica, eles verão um botão\'Tentar outra questão como esta\'. Isso permite que eles tentem uma questão semelhante (selecionada aleatoriamente), sem ter que enviar toda a tentativa do questionário e começar outra tentativa. Essa opção é útil principalmente para testes de prática.
...
O tempo para o questionário \'{$a->quizname}\' no curso \'{$a->coursename}\' expirou. Suas respostas foram enviadas automaticamente em {$a->submissiontime}.
...
Suas respostas para \'{$a->quizname}\' no curso \'{$a->coursename}\' em {$a->attempttimefinish} foram avaliadas agora.
...
$string['eventquizgradeitemcreated'] = 'Item de nota do questionário criado';
$string['eventquizgradeitemdeleted'] = 'Item de nota do questionário excluído';
$string['eventquizgradeitemorderchanged'] = 'Ordem do item de nota do questionário alterada';
$string['eventquizgradeitemupdated'] = 'Item de nota do questionário atualizado';
...
$string['eventslotdisplayedquestionnumberupdated'] = 'Número de questão exibido no espaço foi atualizado';
$string['eventslotgradeitemupdated'] = 'Item de nota do slot atualizado';
$string['eventslotmarkupdated'] = 'Marca do espaço atualizada';
$string['eventslotmoved'] = 'Intervalo movido';
$string['eventslotrequirepreviousupdated'] = 'Necessidade de espaços anteriores atualizada';
$string['eventslotversionupdated'] = 'Versão do intervalo atualizada';
...
$string['feedbackerrororder'] = 'Os limites de pontuação para feedback devem estar em ordem, começando pelo mais alto. O valor inserido no limite {$a} está fora de sequência.';
$string['file'] = 'Arquivo';
...
$string['gradeitemdefaultname'] = 'Novo item de nota {$a}';
$string['gradeitemdelete'] = 'Excluir item de nota {$a}';
$string['gradeitemedit'] = 'Editar nome do item de nota {$a}';
$string['gradeitemmarkscheme'] = 'Atribuir itens de nota';
$string['gradeitemnewname'] = 'Novo nome para o item de nota {$a}';
$string['gradeitemnoneselected'] = '[nenhum]';
$string['gradeitemnoslots'] = 'Este questionário ainda não tem questões. Por favor, adicione questões primeiro e depois retorne aqui para configurar os itens de nota.';
$string['gradeitems'] = 'Itens de nota';
$string['gradeitemsautosetup'] = 'Configurar uma nota para cada seção';
$string['gradeitemsetup'] = 'Configuração de itens de nota';
$string['gradeitemsnoneyet'] = 'Crie itens de nota dentro do seu questionário. Atribua questões ou seções do questionário a esses itens de nota para distribuir os resultados de notas em áreas diferentes.';
$string['gradeitemsremoveall'] = 'Redefinir configuração';
$string['gradeitemsremoveallconfirm'] = 'Redefinir configuração de itens de nota?';
$string['gradeitemsremoveallmessage'] = 'Isso excluirá todos os itens de nota e removerá a atribuição de questões e seções deles.<br><br>Esta ação não afetará as questões e seções em si, nem as tentativas existentes do questionário.';
$string['gradeitemsremovealltitle'] = 'Redefinir configuração de itens de nota';
...
$string['inactiveoverridehelp'] = '* Esta substituição está inativa porque o acesso do usuário à atividade está restrito. Isso pode ocorrer devido às atribuições de grupo ou papel, outras restrições de acesso ou atividade oculta.';
...
$string['indicator:cognitivedepthdef_help'] = 'O participante atingiu esta porcentagem do envolvimento cognitivo oferecido pelas atividades do questionário durante este intervalo de análise (Níveis = Nenhuma visualização, Ver, Enviar, Ver feedback, Comentar sobre o feedback, Reenviar após ver o feedback)';
...
$string['indicator:socialbreadth_help'] = 'Este indicador baseia-se no engajamento social alcançado pelo estudante em uma atividade Questionário.';
...
$string['lastautosave'] = 'Salvo pela última vez: {$a}';
...
$string['marks'] = 'Notas';
$string['marks_help'] = 'A nota obtida para cada questão e a pontuação geral da tentativa. Você só pode selecionar \'Notas\' se \'Pontuação máxima\' estiver selecionada.';
...
$string['maxmarks'] = 'Pontuação máxima';
$string['maxmarks_help'] = 'A pontuação máxima disponível para cada questão.';
$string['messageprovider:attempt_grading_complete'] = 'Notificação de que sua tentativa foi avaliada';
...
$string['messageprovider:quiz_open_soon'] = 'Notificação que o questionário abre em breve';
...
$string['openclosedatesupdated'] = 'Datas de abertura e fechamento';
...
$string['overridecannotchange'] = 'O usuário ou grupo não pode ser alterado após a criação de uma substituição.';
$string['overridecannotsetbothgroupanduser'] = 'Tanto o grupo quanto o usuário não podem ser definidos ao mesmo tempo.';
...
$string['overrideinvalidattempts'] = 'O valor das tentativas deve ser maior que zero.';
$string['overrideinvalidexistingid'] = 'A substituição existente não existe.';
$string['overrideinvalidgroup'] = 'O grupo fornecido não existe.';
$string['overrideinvalidquiz'] = 'O conjunto de ID do questionário não existe.';
$string['overrideinvalidtimelimit'] = 'O limite de tempo deve ser maior que zero.';
$string['overrideinvaliduser'] = 'O usuário fornecido não existe.';
$string['overridemissingdelete'] = 'O(s) ID(s) {$a} de substituição não pôde(puderam) ser excluídos porque não existe(m) ou não faz(em) parte do questionário fornecido.';
$string['overridemultiplerecordsexist'] = 'Não é possível fazer várias substituições para o mesmo usuário/grupo.';
$string['overridemustsetuserorgroup'] = 'Um usuário ou grupo deve ser definido.';
...
$string['previewquiz'] = 'Ver {$a}';
$string['previewquiznow'] = 'Ver prévia do questionário agora';
$string['previewquizstart'] = 'Ver prévia do questionário';
...
$string['questiondraftonly'] = 'A questão {$a} está em status de rascunho. Para usá-la no questionário, vá ao banco de questões e mude o status para pronto.';
...
<p>O questionário <strong>{$a->quizname}</strong> no curso {$a->coursename}, será aberto em breve.
<p><strong>Abertura: {$a->timeopen}</strong></p>
<p><strong>Fechamento: {$a->timeclose}</strong></p>
<p><a href="{$a->url}">Ir para o questionário</a></p>';
$string['quizopendatesoonsubject'] = 'Abre em {$a->timeopen}: {$a->quizname}';
...
$string['quizsetupnavigation'] = 'Configuração da navegação do questionário';
...
$string['randomcoursecatwithsubcat'] = 'Qualquer categoria dentro da categoria do curso {$a}';
$string['randomcoursewithsubcat'] = 'Qualquer categoria neste curso';
$string['randomcreate'] = 'Criar questões aleatórias';
$string['randomediting'] = 'Editando uma questão aleatória';
$string['randomfaultynosubcat'] = 'Questão com erro';
...
$string['randommodulewithsubcat'] = 'Qualquer categoria deste questionário';
...
$string['randomqname'] = 'Questão aleatória com base na condição de filtro';
$string['randomqnamecat'] = 'Aleatório ({$a->category}) baseado em condição de filtro';
$string['randomqnamecattags'] = 'Aleatório ({$a->category}) baseado em condição de filtro com tags: {$a->tags}';
$string['randomqnametags'] = 'Questão aleatória com base na condição de filtro com tags: {$a}';
$string['randomquestion'] = 'Questão aleatória';
$string['randomquestion_help'] = 'Uma questão aleatória é uma maneira de inserir uma questão escolhida aleatoriamente de uma categoria específica ou por uma tag específica em uma atividade.';
...
$string['randomsystemwithsubcat'] = 'Qualquer categoria no nível do sistema';
...
$string['reopenattemptareyousuremessage'] = 'Isso reabrirá a tentativa {$a->attemptnumber} de {$a->attemptuser}.';
$string['reopenattemptareyousuretitle'] = 'Reabrir tentativa?';
$string['reopenattemptwrongstate'] = 'A tentativa {$a->attemptid} está no estado errado ({$a->state}) para ser reaberta.';
...
$string['reopenedattemptwillbesubmitted'] = 'A tentativa será enviada imediatamente para avaliação.';
...
$string['reportmulti_q_x_student'] = 'Escolhas multi-estudantes';
...
$string['reportusersall'] = 'todos os usuários que realizaram tentativas no questionário';
...
$string['sendnotificationopendatesoon'] = 'Notificar o usuário sobre a procimidade da data de abertura do questionário';
...
$string['showcorrectanswer'] = 'Ver respostas corretas no feedback?';
...
$string['summaryofattempts'] = 'Suas tentativas';
...
$string['toomanyrandom'] = 'O número de questões aleatórias necessárias é maior do que as disponíveis na categoria!';
$string['top'] = 'Topo';
$string['totalmarks'] = 'Total de pontos';
