...
/**
 * Strings for component 'oublog', language 'pt_br', version '4.5'.
 *
 * @package     oublog
 * @category    string
...
$string['commentonby'] = 'Comentar na postagem <u>{$a->title}</u> {$a->date} por <u>{$a->author}</u>';
...
$string['maybehiddenposts'] = 'Este {$a->name} pode conter postagens que são visíveis apenas para usuários conectados ou onde apenas usuários conectados podem comentar. Se você tiver uma conta no sistema, por favor <a href="{$a->link}">faça login para acesso completo</a>.';
...
$string['newpost'] = 'Nova postagem de {$a}';
$string['no'] = 'Não';
...
$string['noposts'] = 'Não há postagens visíveis neste {$a}.';
...
$string['searchthisblog'] = 'Pesquisar neste {$a}';
...
$string['subscribefeed'] = 'Inscreva-se em um feed (requer software apropriado) para receber notificações quando este {$a} for atualizado.';
...
$string['views'] = 'Visitas totais a este {$a}:';
