...
/**
 * Strings for component 'subcourse', language 'pt_br', version '4.5'.
 *
 * @package     subcourse
 * @category    string
...
$string['refcourse_help'] = 'O curso referenciado é de onde a nota da atividade é obtida. Os estudantes devem estar inscritos no curso referenciado.

Você precisa ser professor no curso para que ele seja listado aqui. Você pode solicitar ao administrador do seu site para configurar esta atividade para você obter notas de outros cursos.';
