...
/**
 * Strings for component 'assign', language 'pt_br', version '4.5'.
 *
 * @package     assign
 * @category    string
...
$string['attemptreopenmethod_automatic_help'] = 'Após uma tentativa, a próxima é concedida automaticamente.';
...
$string['feedbackavailableanonhtml'] = 'Você tem um novo feedback sobre seu
envio para a tarefa "<i>{$a->assignment}</i>"<br /><br />
Você pode vê-lo anexado ao seu <a href="{$a->url}">envio de tarefa</a>.';
