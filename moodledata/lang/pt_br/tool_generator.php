...
/**
 * Strings for component 'tool_generator', language 'pt_br', version '4.5'.
 *
...
$string['execute_scenarios'] = 'Cenários de teste';
...
$string['progress_createusers'] = 'Criando contas de usuário ({$a})';
...
$string['testscenario_description'] = 'A criação de cenários de teste utiliza uma sintaxe limitada de arquivos de recursos para criar todos os elementos necessários para executar um teste manual.';
$string['testscenario_errorparsing'] = 'Erro ao analisar o arquivo de recursos: {$a}';
$string['testscenario_file'] = 'Arquivo de recursos';
$string['testscenario_filedesc'] = 'A funcionalidade de envio de arquivos só pode conter cenários com etapas do core_data_generator ou algumas etapas específicas que não requerem selenium. Todos os cenários serão executados de uma vez, exceto os com a tag @cleanup.';
$string['testscenario_filedesc_cleanup'] = 'Cenários com a tag @cleanup serão executados apenas se a configuração "Execute" estiver definida para "Cleanup". Para executar o cleanup via CLI, você pode usar a opção --cleanup.';
$string['testscenario_filedesc_list'] = 'Esta é a lista de etapas que podem ser usadas no arquivo da funcionalidade de cenários de teste:';
$string['testscenario_invalidfile'] = 'O formato do arquivo não é válido ou contém etapas inválidas.';
$string['testscenario_invalidstep'] = 'Etapa desconhecida. A criação de cenários de teste aceita apenas etapas de geração.';
$string['testscenario_nosteps'] = 'Não há etapas para executar no arquivo.';
$string['testscenario_notready'] = 'Os bibliotecas Composer e Behat não estão instaladas.<br><br>
Execute este comando para habilitar esta ferramenta: <strong>php admin/tool/generator/cli/runtestscenario.php</strong>';
$string['testscenario_outline'] = 'Esquemas de cenários não são suportados.';
$string['testscenario_scenarionosteps'] = 'Este cenário não possui etapas.';
